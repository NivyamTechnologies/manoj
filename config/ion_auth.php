...
$config['admin_email']                = "amit.sadaphal@gmail.com"; // Admin Email, admin@example.com
...
$config['maximum_login_attempts']     = 15;                   // The maximum number of failed login attempts.
 ...
 */
$config['use_ci_email'] = TRUE; // Send Email using the built in CI email class, if false it will return the code and the identity
$config['email_config'] = array(
	'mailtype' 		=> 'html',
	  'smtp_host' 	=> 'ssl://smtp.googlemail.com',
	  'smtp_user' 	=> 'amit.sadaphal@gmail.com',
	  'smtp_pass' 	=> 'amitmci@123',
	  'smtp_port' 	=> '465',
	  'charset' 	=> 'utf-8',
	  'newline' 	=> '\r\n',
	  'mailtype' 	=> 'html',		
