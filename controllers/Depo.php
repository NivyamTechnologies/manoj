...
{				
    ...
    public function depoview($file,$data='')
	{
	...
	$data['data']=$lll;	
	$this->load->view('depo/depoheader',$data);
	$this->load->view('depo/deposidebar',$data);
	$this->load->view($file,$data);
    $this->load->view('depo/depofooter',$data);	
	}
	
	public function index()
	{
	$this->depoview('depo/depoprofile','');	
	}
