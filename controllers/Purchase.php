...
{				
	...
	public function purchaseview($file,$data='')
	{
	...
	$data['data']=$lll;	
	$this->load->view('purchase/purchaseheader',$data);
	$this->load->view('purchase/purchasesidebar',$data);
	$this->load->view($file,$data);
    $this->load->view('purchase/purchasefooter',$data);	
	}
	
	public function index()
	{
	$this->purchaseview('purchase/purchaseprofile','');	
	}
