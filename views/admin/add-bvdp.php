...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<a href="<?php echo base_url()?>admin/bvdplist"><button class="btn green" style="margin:5px;">BV/DP LIST <i class="fa fa-plus"></i>
</button></a><br/>
			<div class="row">
				<div class="col-md-12">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addbvdp') ?>
					...
					<label class="control-label col-md-4">Date:</label>
							...
							<input type='text' class="form-control" id="date" name="date" readonly required>									
                              ...
                              <div class="row">	
									<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">Total BV:</label>
										<div class="col-md-8">
							<input type="number" name="bv" id="bv" class="form-control" placeholder="Enter BV" required  autocomplete="off" />
                                        ...
                                        <div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">Total DP:</label>
										<div class="col-md-8">
							<input type="number" name="dp" id="dp" class="form-control" placeholder="Enter DP" required   autocomplete="off" />
											...
											<div class="form-actions fluid">
												...
												<input type="submit" name="bank_update" class="btn green" value="Update"/>
													...
													<input type="submit" name="submit" onclick="return deletebill()" value="Submit" class="btn green"/>
														<?php
													}?>
