...
<div class="page-container">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addcategory/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				...
				?>
										...
										<div class="col-md-9">
											<input type="text" name="category_name" class="form-control" id="exampleInputEmail1" value="<?php echo $category_name;?>" placeholder="Enter text">
											...
											<div class="col-md-6">
											<div class="form-group">
							<label class="control-label col-md-6">Category Image</label>
															<div class="col-md-6">
				<input type="file" name="category_image" required id="exampleInputFile1">
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													{
														?>
												<input type="submit" name="category_update" class="btn green" value="Update"/>
															<?php
													}else{?>
													<input type="submit" name="category_update" value="Submit" class="btn green"/>
														<?php
													}?>
															<a class="btn btn default" href="<?php echo base_url()?>admin/category">Cancel</a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
