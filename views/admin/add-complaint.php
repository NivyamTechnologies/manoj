...
<div class="page-container">
  ...
  <?php 
		if ($this->session->flashdata('success1')) 
		{
		 ...
		 ?>                                            
    <div class="form-body">
        <h3 class="form-section">ADD Complaint  </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label class="control-label col-md-8">Manager ID</label>
                    <div class="col-md-10">
                        <input type="text" id="branch_id1" name="branch_id1" class="form-control" required onchange="getbranchdata1(this.value)"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8"> Manager Name:</label>
                    <div class="col-md-10">
                        <input type="text" name="distributor_name1" id="bvmbranchname1" class="form-control" placeholder="Enter Name"  readonly autocomplete="off" />
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8">Complaint Subject</label>
                    <div class="col-md-10">
             ...
             <div class="col-md-10">
                        <textarea  name="desc" id="desc" class="form-control" placeholder="Description Here"   >
                        </textarea>
...
jQuery.post("<?php echo base_url();  ?>admin/getdataledger", {no: str}, function(result){
	dataArray = jQuery.parseJSON(result);
	   ...
	   if(dataArray[0].dpname!=null)
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].dpname);   
	   }
	   else if(dataArray[0].pucname!=null) 
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].pucname);   
	   }
	   else if(dataArray[0].brname!=null) 
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].brname);   
	   }
	   else if(dataArray[0].membername!=null) 
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].membername);   
	   }
	   else if(dataArray[0].party_name!=null) 
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].party_name);   
	   }
	   else if(dataArray[0].admin!=null) 
	   {
	   jQuery("#bvmbranchname1").val(dataArray[0].admin);   
	   }
	   //jQuery("#creditlimit").val(dataArray[0].creditlimit);
	   }
    });		
