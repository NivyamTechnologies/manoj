...
<link rel="shortcut icon" href="<?php echo base_url()?>favicon.ico"/>
 ...
 <script src="<?php echo base_url().'assets/scripts/jquery-1.10.1.min.js';?>" type="text/javascript"></script>
        ...
        <script type="text/javascript">
			...
			$("#Mobile,#date").keyup(function() {
				var date = $("#date").val().split('-');
				var fname = $("#Mobile").val();    
				var orgId = fname.charAt(0)+ date.join('');
				$("#OrgID").val(orgId);
			});
		});	
		</script>
...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url('admin/allorganization');?>">
								Organization
							</a>
    ...
    <?php } ?>  
				...
				foreach($vieworginfo as $userdata)
						{
							$applicant_no = $userdata->applicant_no;
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Organization ID</label>
															<div class="col-md-8">
																<input type="text" id="OrgID" name="applicant_no" class="form-control" readonly autocomplete="on" value=""/>	
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Organization Role</label>
															<div class="col-md-8">
																	<?php

						$Orgrole = array('subadmin' => 'subadmin'); 
		  
		  echo form_dropdown('Orgrole',$Orgrole,$org_role,'class="form-control" id="Orgrole"'); ?>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="FirstName" name="FirstName" class="form-control" placeholder="Enter FirstName" required autocomplete="off" value=""/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="password" id="LastName" name="password" class="form-control" placeholder="Enter password" required autocomplete="off" />
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="Emailid" name="Emailid" class="form-control" placeholder="Enter Emailid" required autocomplete="off" value="<?php echo $Emailid;?>"/>				
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													if($this->uri->segment(3)!='')
													{
														...
														<button type="submit" name="org_update" class="btn green">Submit</button>
														<?php
													}?>
