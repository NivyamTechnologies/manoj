...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/purchasechalanIGST">
							Bill
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addpurchasechalanIGST/'); ?>
    ...
    <?php } ?>  
				...
				?>
						...
						<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">2.Party Name:</label>
										<div class="col-md-8">
					...
					<label class="control-label col-md-4">Date:</label>
						...
						<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">3.Bill No:</label>
										<div class="col-md-8">
							<input type="text" name="bvmbillno" id="bvmbillno" class="form-control" placeholder="Enter Bill No"  autocomplete="off" />
					...
					<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">4.Narration:</label>
										<div class="col-md-8">
							<input type="text" name="bvmnarration" id="bvmnarration" class="form-control" placeholder="Enter Narration"  autocomplete="off" />
...
{
jQuery.post("<?php echo base_url();  ?>admin/getledger", {no: str}, function(result){
	dataArray = jQuery.parseJSON(result);
       if(result=='1')
	   {
	   jQuery("#bvmbranchname").val('');
	   jQuery("#branch_id").val('');
	   alert("Ledger Id. not exist");	   
	   }
	   else
	   {
  ...
  $( function() {
    ...
    $( "#productlist" ).autocomplete({
     ...
     //productprice = ((product_dp - dscomsn)*100/product_taxrate)+100;
	 ...
	 htmls += "<td><input  name='product_rate[]' type='text' id='product_rate"+k+"' onchange ='calculateatprice(this.value,"+k+")' class='form-control input-md'></td>";
	 htmls += "<td><input  name='product_total[]' type='text' id='product_total"+k+"' readonly class='form-control input-md'></td>";
     htmls += "<td><input  name='tax_rate[]' type='text' id='tax_rate"+k+"' readonly value='"+product_taxrate+"' class='form-control input-md'><input  name='tax_rate_igst[]' type='hidden' id='tax_rate_igst"+k+"' readonly value='"+product_igst+"' class='form-control input-md'></td>";
	 
	 
	 htmls += "<td><input  name='igst[]' type='text' id='igst"+k+"' readonly class='form-control input-md'></td>";
  ...
  function calculateatprice(price,pid)
  {
  rate = price;
  quantity =$("#qty").val();
  $("#product_total"+pid).val(rate*quantity);
  
    igst = ((rate*quantity) * $("#tax_rate_igst"+pid).val())/100;
    $("#igst"+pid).val(igst);  
    igst = $("#igst"+pid).val();
    $("#taxpricetotal"+pid).val(Number(price*quantity)+Number(igst));  
  ...
  quantity =$("#qty").val();
   aq = parseInt($("#product_quantity"+pid).val()) - Number($("#quantity"+pid).val());
  
  proint = parseInt(quantity) + aq;
  $("#quantity"+pid).val(quantity);
  $("#product_quantity"+pid).val(proint); 
  }
  //$("#rowsecond"+i).show();	 
  }
