...
<div class="page-container">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addschemecategory/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				<?php				
				foreach($viewschemeinfo as $userdata)
						{
							$productid = $userdata->product_id;
							$scheme_price = $userdata->scheme_price;
				...
				?>
										...
										<div class="col-md-9">
										<?php
										 echo form_multiselect('category[]',$category,explode(',',$selectedcategory[0]['category']),'class="form-control" multiple id="product_id" required'); ?>
