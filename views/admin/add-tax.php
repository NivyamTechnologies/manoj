...
<div class="page-container">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addtax/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				<?php				
				foreach($viewtaxinfo as $userdata)
						{
												...
												<div class="row">													
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Tax Rate</label>
															
										<div class="col-md-9">
<input type="text" name="tax_rate" class="form-control" id="tax_rate" value="<?php echo $tax_rate;?>" placeholder="Enter Tax rate value without % sign">
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													{
														?>
												<input type="submit" name="tax_update" class="btn green" value="Update"/>
															<?php
													}else{?>
													<input type="submit" name="tax_update" value="Submit" class="btn green"/>
														<?php
													}?>
															<a class="btn btn default" href="<?php echo base_url()?>admin/tax">Cancel</a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
