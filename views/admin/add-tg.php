...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/addtg">
							Transaction
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addtg/'); ?>
    ...
    <?php } ?>  
				...
				?>
					...
					<div class="col-md-4">
								<div class="form-group">
						<label class="control-label col-md-4">Enter To ID</label>
                                <div class="col-md-6">
					...
					<label class="control-label col-md-4">3.Ledger Amount</label>
					<div class="col-md-8">
					<input type="text" name="ledgerlimit1" id="ledgerlimit1" class="form-control" readonly autocomplete="off" />
					</div>
					</div>
					</div>
							...
							<div class="col-md-8">
							<input type="text" name="narration" id="narration" required class="form-control"/>
