...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/ttbv">
							Transfer
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addttb/'); ?>
    ...
    <?php } ?>  
				...
				?>
											...
											<div class="form-body">
												<h3 class="form-section">Transfer Info</h3>
												
												<div class="row">
								<div class="col-md-4">
								<div class="form-group">
								<label class="control-label col-md-4">Branch Login ID</label>
                                <div class="col-md-6">
						...
						<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">2. Branch Name:</label>
										<div class="col-md-8">
					...
					<div class="col-md-4">
					<div class="form-group">
					<label class="control-label col-md-4">3.Credit Limit</label>
					<div class="col-md-8">
...
{
jQuery.post("<?php echo base_url();  ?>admin/getbranchdata", {no: str}, function(result){
  ...
  $( function() {
    ...
    $( "#productlist" ).autocomplete({
	 ...
	 htmls += '<td><input  name="quantity[]" type="text" id="quantity'+k+'" placeholder="quantity" readonly class="form-control input-md" required></td>';
	    
	 
     productprice = product_mrp_price;
  ...
  {
  pid=$("#productid").val();
  rate = Number($("#product_rate"+pid).val());
  quantity =Number($("#qty").val());
  if(quantity > Number($("#product_quantity"+pid).val()))
  {
  alert("Quntity should less then avl. quantity");	 
  }
  else
  {
  $("#product_total"+pid).val(Number(rate*quantity));
