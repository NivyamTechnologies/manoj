			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
						...
						<option value="Silver Leaders">Silver Leaders</option>
						...
						<option value="Pearl Leaders">Pearl Leaders</option>
						<option value="Ruby Leaders">Ruby Leaders</option>
						...
						<option value="Peltinum Diamond">Peltinum Diamond</option>
						<option value="Opel Diamond">Opel Diamond</option>
						<option value="Pearl Diamond">Pearl Diamond</option>
						<option value="Ruby Diamond">Ruby Diamond</option>
						</select>
