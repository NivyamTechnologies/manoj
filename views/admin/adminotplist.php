    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
            ...
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php foreach($adminotplist as $adminotplist){ ?>
                <tr>
                    <td><?php echo $adminotplist->branch_id;?></td>
                    <td><?php echo $adminotplist->branch_name;?></td>
                    <td><?php echo $adminotplist->totaldp;?></td>
					 <td><?php echo $adminotplist->totalbv;?></td>
