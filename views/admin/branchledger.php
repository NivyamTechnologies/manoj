            ...
            <table id="myTable" style="border: 2px solid black"  class="table table-striped table-hover table-bordered">
			  ...
			  <?php $totolfinal =  $totolfinal+( $branchledger->totaldp-(isset($branchledger->amount)  ? $branchledger->amount : 0));?>
                <tr> 
					...
					<td  style="border: 2px solid black" >  <?php echo $branchledger->branch_id;?>/ <?php echo $branchledger->branch_name;?></td>
					<td style="border: 2px solid black" ><?php echo 'BVM/'.getfin($branchledger->datetime).'/'.$branchledger->s_no;?></td>
					<td style="border: 2px solid black" ><?php echo $branchledger->totaldp;?></td>
					 <td style="border: 2px solid black"><?php echo $branchledger->amount;?></td>
