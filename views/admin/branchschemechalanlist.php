...
<div class="page-container">
	...
	<div class="page-content-wrapper">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url();?>admin/branchschemechalanlist); ">
								Scheme Chalan
							</a>
		...
		<div class="table-toolbar">
								<div class="btn-group">
	                    <form name="serach" action="<?php echo base_url() ?>admin/branchschemelist" method="POST">
						<table>
						<tr>
                        <td style="padding-right: 25px;"><input type='number' class="form-control" id="spanno" name="spanno" placeholder="Branch No."></td>  
						<td style="padding-right: 25px;"><input type="submit" class="btn btn-primary" value="search" name="search"/></td>
							...
							<tr>								
								...
								<td>
								<?php 
								echo $this->base_model->getpucbranchname($r->branch_id)."(".$r->branch_id.")";
								?>
								</td>
								<td>
								<?php 
								$createb=$this->db->query("select applicant_no from mlm_members_login where member_id='".$r->createby."'"))->row();
								echo $this->base_model->getpucbranchname($createb->applicant_no)."(".$createb->applicant_no.")";
								?>
								</td>
                                <td>
								<?php echo $r->datetime	;?>
								...
								<td>
								<a href="<?php echo base_url();?>admin/schemechalan/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
