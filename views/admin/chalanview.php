...
<head>
<meta charset="utf-8"/>
<title>Assuredness Business</title>
...
<div id="printme">
    ...
    <h2 class="text-center">BILL OF SUPPLY</h2>
        ...
        <tr>
                <td colspan="3">
				Assuredness Marketing Pvt. Ltd.	<br/>
                161,Raipur, Muzaffarnagar	<br/>
                Distt - Muzaffarnagar (U.P.) 251309, Ph. 9058670777	<br/>
                ...
                <td colspan="4">AVM/19-20/<?php echo $productlist[0]->s_no;  ?></th>
				</tr>
				<tr>
		...
		$i++;} ?>
            ...
            <tr>
                ...
                <td colspan="3"></td>
                <td colspan="4">For Assuredness Marketing Pvt. Ltd.</td>
            </tr>
