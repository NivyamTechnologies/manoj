        ...
        <div class="btn-group">
         ...
         <form id="sms_form">
            <table class="table  table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php 
              if(!isset($alluser)){ $alluser= array(); }
              foreach($alluser as $user){ ?>
                <tr>
                    <td><?php echo $user->applicant_no;?>
                    </td>
                    <td><?php echo $user->applicant_name;?>
                      
                    </td>  
					<td ><?php echo $user->mobile_no;?>
					
					<td ><?php echo $user->panno;?></td>
					<td ><?php echo $user->bank_name;?></td>
					<td ><?php echo $user->bank_accno;?></td>
					<td ><?php echo $user->bank_ifsc_code;?></td>
					<td ><?php echo $closing[$user->applicant_no];?></td>
