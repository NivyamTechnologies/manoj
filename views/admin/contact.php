...
<div class="page-container">
    ...
    <?php } ?>  
							...
							<tbody>
							<?php if(count($Allcontact)>0) { 
							$i=1;
						foreach($Allcontact as $r)
						{	
						?>
							...
							<tr>								
								...
								<td>
									<a href="<?php echo base_url();?>admin/deleteContact/<?php echo $r->id;?>" onclick="return confirm('Are you sure you want to delete this Contact?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
								</td>
							</tr>
