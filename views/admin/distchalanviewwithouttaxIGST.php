        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								<a href="<?php echo base_url();?>admin/distchalanwithouttaxIGST/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
								...
								{
								?>
								<a href="<?php echo base_url();?>admin/deletebill/distributor/<?php echo $r->chalan_id;?>/distchalanviewwithouttaxIGST" onclick="return deletebill()">Delete</a>
							    <?php }
								elseif($r->billfromtype==2)
								{
									$createb=$this->db->query("select applicant_no from mlm_members_login where member_id='".$r->createby."'")->row();
									if(isset($createb->applicant_no)){
								?>
								
								<a href="<?php echo base_url();?>admin/deletebillall/<?php echo $r->branch_id;?>/<?php echo $createb->applicant_no; ?>/distributor/<?php echo $r->chalan_id;?>/distchalanviewwithouttaxIGST" onclick="return deletebill()">Delete</a>
