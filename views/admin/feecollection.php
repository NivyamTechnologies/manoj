...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/feecollection">
								Fee 
							</a>
    ...
    <?php } ?>  
							<div class="table-toolbar">
								<div class="btn-group">
				<?php echo form_open_multipart('admin/feecollection'); ?>
										<table width="800">
                    <tr><td>
                    <div class="col-md-8">
		  ...
		  echo form_dropdown('fee',$options,$fee,'class="form-control" id="fee"'); ?>
									</div>
