            ...
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <?php foreach($toolkitlist as $toolkitlist){ ?>
                <tr>
                    ...
                    <td><?php echo $toolkitlist->sponsor_id;?>
			
				</td>

					   <td><?php echo $toolkitlist->other_bonus;?>
							    <td><?php echo $toolkitlist->other_bonus2;?>
								<td><?php echo $toolkitlist->other_bonus3;?>
								<td><?php echo $toolkitlist->other_bonus4;?>
								<td><?php echo $toolkitlist->other_bonus5;?>
								<td><?php echo $toolkitlist->other_bonus6;?>
								<td><?php echo  $toolkitlist->other_bonus+ $toolkitlist->other_bonus2+ $toolkitlist->other_bonus3+$toolkitlist->other_bonus4+ $toolkitlist->other_bonus5+$toolkitlist->other_bonus6;?>
