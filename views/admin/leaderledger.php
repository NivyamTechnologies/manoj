            ...
            <table id="myTable" style="border: 2px solid black"  class="table table-striped table-hover table-bordered">
              <thead>
                <tr>
					...
					<td  style="border: 2px solid black">Payment By</td>
              ...
              <tbody> 
              <?php foreach($leaderledger as $leaderledger){ ?>
			  <?php $totolfinal =  $totolfinal+( $leaderledger->totaldp-(isset($leaderledger->amount)  ? $leaderledger->amount : 0));?>
                <tr> 
				<td  style="border: 2px solid black" ><?php echo date("Y-m-d",strtotime($leaderledger->datetime));?></td>
                  <td  style="border: 2px solid black" ><?php echo $leaderledger->createby;?></td>
				  <td style="border: 2px solid black" ><?php echo 'BVM/'.getfin($leaderledger->datetime).'/'.$leaderledger->s_no;?></td>
				  <td style="border: 2px solid black" ><?php echo $leaderledger->v;?></td>
					<td style="border: 2px solid black" ><?php echo $leaderledger->totaldp;?></td>
					 <td style="border: 2px solid black"><?php echo $leaderledger->amount;?></td>
