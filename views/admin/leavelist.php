...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Leave List
							</div>
    ...
    <?php } ?>  
							...
							<?php if(count($leavelists)>0) { 
					$i=1;					
					
					foreach($leavelists as $r)
					{
						
						$dateofregistration = date_create($r->request_leave_date);
				...
				?>
							...
							<tr>								
								...
								<td><?php 
									$qq=$this->base_model->get_teacher($r->empid);
									
		                            echo $qq[0]['FirstName'].'&nbsp;'.$qq[0]['LastName'];
		                            ?></td>
								<td>
									<?php echo $r->leave_type; ?>
								</td>								
								<td>
									<?php echo $r->leave_resion; ?>
								</td>
								<td>
									<?php echo $registration_date;?>
								</td>								
								<td>
									<?php echo $r->leave_from; ?>
								</td>
								<td>
									<?php echo $r->leave_to; ?>
								</td>													
								...
								{
									if($r->leave_permission=='')
									{
								?>
									<a href="<?php echo base_url();?>admin/leaveapprove/<?php echo $r->id.'/'.$r->empid;?>" onclick="return confirm('Are you sure you want to Approve this Leave?')" class="btn bg-primary wnm-user">Not Approved</a>
								<?php }
								else{
									?>
									<a href="" onclick="return confirm('You have already Approve this Leave?')" class="btn bg-primary wnm-user">Approved</a>
								<?php
								}}?>
								</td>
