    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
           ...
           <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
							...
							if(count($ledercomission)>0) 
							{ 
					        $i=1;
					        foreach($ledercomission as $r)
					        {
							...
							<tr>								
                               ...
                               <td>
								...
								<td> <?php echo $r->bvmpuc_leadercommision	;?></td>
								<td> <?php echo $r->bvmpuc_distributor	;?>
								<input type="hidden" value="<?php echo $r->bvmpuc_distributor;?>" name="ApplicantNo[]"></td>
								<td> <?php echo $r->applicant_name	;?></td>
								<td> <?php echo $r->mobile_no	;?></td>
								<td> <?php echo $r->total	;?>
								 <input type="hidden" value="<?php echo $r->total;?>" name="amount[]"></td>
