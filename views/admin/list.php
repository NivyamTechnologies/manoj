							...
							<tr>								
                               ...
                               <td>
								...
								<?php if($this->session->userdata('empid')==7){ ?>
									<button type="button" data-id="<?php echo $r->id;?>" class="btn btn-danger btn-xs delete">Delete</button>
			                    <?php } ?>
...
jQuery(document).ready(function() {       
   ...
   $( "body" ).on( "click", ".delete", function() {
	   ...
	   var r = confirm("Are you sure!");
		if (r == true) {
		  $.post( "<?php echo base_url("admin/delete_transation")?>", { tId: tId }).done(function( data ) {
