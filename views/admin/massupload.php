...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/massupload">
								Attendance
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					 <form method="post" action="<?php echo base_url();?>admin/readattendanceexcel" id="excel_questions_form" enctype="multipart/form-data">
    ...
    <?php } ?>  
											...
											<div class="form-body">
												<h3 class="form-section">MassUpload Info</h3>
												
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Sheet</label>
          ...
          {			
			//form validation rules
              $("#excel_questions_form").validate({
   			...
   			messages: {
   				attendancefile: {
                          required: "Please upload the Excel file as given in the sample xls file format.",
                          accept: "Please upload the Excel file as given in the sample xls file format."
   				}
   			},
