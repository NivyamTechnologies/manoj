   ...
   <?php
    ...
    <div id="response"> </div>
            ...
            <?php  foreach($data1 as $key=>$value)
                ...
                <li class="column" id="arrayorder_<?php echo $value['id']; ?>"><a href="#"><?php echo $value['menu_name']; ?></a>
                    ...
                    <ul>
                      ...
                      <?php
                        ...
                        <li><a href="#"><input  type="checkbox" id="<?php echo $value1['id'] ?>" <?php if($value1['menu_status']=='active'){?> checked <?php } ?> onClick="checks(<?php echo $value1['id'] ?>)"><?php echo $value1['menu_name']; ?></a>
                            ...
                            if(count($value1['subchild'])!=0)
							  ...
							  ?>
                                ...
                                <li><a href="#"><input type="checkbox"  id="<?php echo $value2['id']; ?>" <?php if($value2['menu_status']=='active'){?>checked<?php } ?> onClick="checks(<?php echo $value2['id'] ?>)"><?php echo $value2['menu_name']; ?></a>
						            ...
						            foreach($value2['subsubchild'] as $key3=>$value3)
                                     ...
                                     <li><a href="#"><input  type="checkbox" id="<?php echo $value3['id'] ?>" <?php if($value3['menu_status']=='active'){?> checked <?php } ?> onClick="checks(<?php echo $value3['id'] ?>)"><?php echo $value3['menu_name']; ?></a></li>
