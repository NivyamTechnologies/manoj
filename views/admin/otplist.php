    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
            ...
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php foreach($otplist as $otplist){ ?>
                <tr>
                    <td><?php echo $otplist->branch_id;?></td>
                    <td><?php echo $otplist->branch_name;?></td>
                    <td><?php echo $otplist->s_no;?></td>
					 <td><?php echo $this->base_model->getpucbranchname($otplist->createby);?></td>
					 <td><?php echo $otplist->datetime;?></td>
					  <td><?php echo $otplist->status;?></td>
