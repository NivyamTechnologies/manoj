	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Purchase Chalan CGST List
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						
						<li>
							<i class="fa fa-home"></i>
							<a href="<?php echo base_url();?>admin/purchasechalanviewCGST">
								Purchase Chalan
							</a>
        ...
        <?php } ?>  
							...
							<tr>								
								...
								<td>
								<a href="<?php echo base_url();?>admin/deletebill/purchase/<?php echo $r->chalan_id;?>/purchasechalanviewCGST" onclick="return deletebill()">Delete</a>							    
								</td>
