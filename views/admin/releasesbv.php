    ...
    <div class="table-responsive">
        <div class="btn-group">
            ...
            <table class="table  table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php 
              if(!isset($releasesbv)){ $releasesbv= array(); }
              foreach($releasesbv as $releasebv){ ?>
				  <form id="id<?php echo $releasebv->applicant_no;?>" class="releasesbv">
					<tr>
						<td><?php echo $releasebv->applicant_no;?>
						</td>
						<td><?php echo $releasebv->applicant_name;?>
						   <input type="hidden" name="applicant_name[<?php echo $releasebv->applicant_no;?>]" value="<?php echo $releasebv->applicant_name;?>">
						   <input type="hidden" name="applicant_no[<?php echo $releasebv->applicant_no;?>]" value="<?php echo $releasebv->applicant_no;?>">
						</td>  
						<td ><?php echo $releasebv->mobile_no;?>
						<input type="hidden" name="mobile_no[<?php echo $releasebv->applicant_no;?>]" value="<?php echo $releasebv->mobile_no;?>">
						<input type="hidden" name="total[<?php echo $releasebv->applicant_no;?>]" value="<?php echo $releasebv->total;?>"></td>
						<td><?php echo $releasebv->total;?></td>
						<td><?php echo $releasebv->date;?></td>
						<td><input type="text" name="narration[<?php echo $releasebv->applicant_no;?>]"></td>
						<td>
						<?php if($this->session->userdata('empid')==7){ ?>
						<input type="button" name="Process" data-id="<?php echo $releasebv->applicant_no;?>" class="process btn btn-primary" value="Process">
						<?php } ?>
						</td>
					</tr>
				  </form>
    ...
    -----------------------------------------------------------*/
		...
		$(document).ready(function(){
			$('.process').click(function(){ 
				...
				$.post("<?php echo base_url("admin/process_releasesbv"); ?>", $('#id'+id).serialize()).done(function( data ) {
