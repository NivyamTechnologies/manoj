            ...
            <table id="mypivotTable" class="table table-striped table-hover table-bordered">
              <thead>
                <tr id="pivotTR">
                    <td> No.</td>
                    <?php 
                    foreach($previousMonth as $previousMon){
						switch($previousMon) {
								case 1:
									echo "<td>Jan</td>";
									break;
              ...
              <tbody>
				...
				foreach($pivotlists as $key => $pivotlist){  if (!in_array($pivotlist->applicant_no, $all_applicant_no)){ continue; } ?>
                    ...
                    foreach($previousMonth as $previousMon){
						switch($previousMon) {
								case 1:
									echo "<td style='background-color:".$color[($pivotlist->jan==null)?3:$pivotlist->jan]."'>".$dplistTargetdata[$key]->jan."</td>";
									break;
								case 2:
									echo "<td style='background-color:".$color[($pivotlist->feb==null)?3:$pivotlist->feb]."'>".$dplistTargetdata[$key]->feb."</td>";
									break;
								case 3:
									echo "<td style='background-color:".$color[($pivotlist->mar==null)?3:$pivotlist->mar]."'>".$dplistTargetdata[$key]->mar."</td>";
									break;
								case 4:
									echo "<td style='background-color:".$color[($pivotlist->apr==null)?3:$pivotlist->apr]."'>".$dplistTargetdata[$key]->apr."</td>";
									break;
								case 5:
									echo "<td style='background-color:".$color[($pivotlist->may==null)?3:$pivotlist->may]."'>".$dplistTargetdata[$key]->may."</td>";
									break;
								case 6:
									echo "<td style='background-color:".$color[($pivotlist->jun==null)?3:$pivotlist->jun]."'>".$dplistTargetdata[$key]->jun."</td>";
									break;
								case 7:
									echo "<td style='background-color:".$color[($pivotlist->jul==null)?3:$pivotlist->jul]."'>".$dplistTargetdata[$key]->jul."</td>";
									break;
								case 8:
									echo "<td style='background-color:".$color[($pivotlist->aug==null)?3:$pivotlist->aug]."'>".$dplistTargetdata[$key]->aug."</td>";
									break;
								case 9:
									echo "<td style='background-color:".$color[($pivotlist->sep==null)?3:$pivotlist->sep]."'>".$dplistTargetdata[$key]->sep."</td>";
									break;
								case 10:
									echo "<td style='background-color:".$color[($pivotlist->oct==null)?3:$pivotlist->oct]."'>".$dplistTargetdata[$key]->oct."</td>";
									break;
								case 11:
									echo "<td style='background-color:".$color[($pivotlist->nov==null)?3:$pivotlist->nov]."'>".$dplistTargetdata[$key]->nov."</td>";
									break;
								case 12:
									echo "<td style='background-color:".$color[($pivotlist->decm==null)?3:$pivotlist->decm]."'>".$dplistTargetdata[$key]->decm."</td>";
									break;
								}
							}
						?>
