...
<div class="bs-example table-responsive">
    ...
    <h2 class="text-center">INVOICE</h2>
		...
		?>
                ...
                <td colspan="4">BVM/17-18/<?php echo $productlist[0]->chalan_id;  ?></th>
				</tr>
				<tr>
             ...
             <tr>
                <td colspan="3">
				Transfer Details <br/>	
                <?php  echo $bpdetail[0]['bvmbranchname']; ?>(<?php  echo strtoupper($detail[0]['role']); ?>)<br/>	
                <?php  echo $bpdetail[0]['address'] ?><br/>	
                Contcat:-<?php  echo $bpdetail[0]['mobno'] ?><br/>				
				</td>
                <td colspan="10"></td>
            </tr>
