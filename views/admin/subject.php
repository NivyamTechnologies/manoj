...
<a href="<?php echo base_url()?>admin/addsubject"><button class="btn green">Add New <i class="fa fa-plus"></i></button></a>
							...
							<tbody>
					<?php if(count($Allsubject)>0) { 
					$i=1;
					
					foreach($Allsubject as $r)
					{
				...
				?>
							...
							<tr>								
								...
								<td>
									<a class="btn bg-primary wnm-user" href="<?php echo base_url()?>admin/addsubject/<?php echo $r->id;?>">
										 Edit
									</a>
								</td>
								<td>
									<a href="<?php echo base_url();?>admin/deleteSubject/<?php echo $r->id;?>" onclick="return confirm('Are you sure you want to delete this Subject?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
								</td>
							</tr>
