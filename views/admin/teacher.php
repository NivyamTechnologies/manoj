...
<a href="<?php echo base_url()?>admin/addteacher"><button class="btn green">Add New <i class="fa fa-plus"></i></button></a>
		...
		<img src="<?php echo base_url().'teacherimage/'.$r->teacher_image;?>" height="50px;" width="50px;"/>	  
								...
								?>
									...
									<a href="<?php echo base_url()?>admin/addteacher/<?php echo $r->aid;?>" class="btn bg-primary wnm-user">
								...
								?>
									...
									<a href="<?php echo base_url();?>admin/deleteTeacher/<?php echo $r->aid;?>" onclick="return confirm('Are you sure you want to delete this Teacher?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
                        ...
                        echo form_open('admin/teacherstatus');
