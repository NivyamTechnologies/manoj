...
<div class="page-container">
    ...
    <?php } ?>  
							...
							<?php echo form_open_multipart('admin/findteacherlist'); ?>
										<table width="800">
                    <tr><td>
                    <div class="col-md-8">
														<div class="form-group">
															<label class="control-label col-md-8">Coaching </label>
															
										<div class="col-md-12">
											<?php 
		  
		  echo form_dropdown('coaching',$coaching,$coaching,'class="form-control" id="coaching"'); ?>
						...
						<td align="center"><input type="submit" class="btn btn-sm" data-toggle="modal" name="search" value="Find"/></td><td>&nbsp;</td>
						<td><a href="<?php echo base_url()?>admin/teacherlist" class="btn bg-primary wnm-user">
										Back
									</a></td>
											</tr>
										</table>
		...
		<img src="<?php echo base_url().'teacherimage/'.$r->teacher_image;?>" height="50px;" width="50px;"/>	  
								...
								<td>								
									<a href="<?php echo base_url();?>admin/generatestructure/<?php echo $r->Tecid;?>" class="btn bg-primary wnm-user">View Structure</a>
								</td>
								<td>								
									<a href="<?php echo base_url();?>admin/generatesalary/<?php echo $r->Tecid;?>" onclick="return confirm('Are you sure you want to generate salary for this month?')" class="btn bg-primary wnm-user"><i class="fa fa-circle"></i> Generate Salary</a>
