        ...
        <div class="btn-group">
          <form name="serach" action="<?php echo base_url('admin/report_save'); ?>" id="save_report" method="POST">
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php foreach($toolkitlist as $toolkitlist){ ?>
                <tr>
                    <td><?php echo $toolkitlist->chalan_id;?>
				
				</td>
                    <td><?php echo $toolkitlist->ApplicantNo;?>
			
				</td>
                    <td><?php echo $toolkitlist->branch_name;?>
				<input type="hidden" value="<?php echo leader_commission;?>" name="report_filter">
				</td>
				
					 <td><?php echo $toolkitlist->product_name;?></td>
					  <td><?php echo $toolkitlist->ProposerNo;?>
					  	<input type="hidden" value="<?php echo $toolkitlist->ProposerNo;?>" name="ApplicantNo[]">
					  <input type="hidden" value="<?php echo $month;?>" name="month">
                        <input type="hidden" value="<?php echo $year;?>" name="year">
					  </td>
					   <td><?php echo $toolkitlist->proposername;?></td>
					    <td><?php echo $toolkitlist->ProposerMobile;?></td>
						<td><?php echo $toolkitlist->quantity;?></td>
                      <td><?php echo $toolkitlist->amount;?>
				  <input type="hidden" value="<?php echo $toolkitlist->amount;?>" name="amount[]">
				  </td>
                </tr>
                <?php } ?>
                </tbody>
