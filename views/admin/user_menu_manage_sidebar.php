...
<div class="container" style="margin-top:30px;">
    ...
    <div id="response"> </div>
			...
			foreach($data1 as $key=>$value)
			 { 
                $checkid= $this->base_model->check_menu($userid,$value['id'],$eid);
				 ?>

                <li class="column"><input  type="checkbox" id="<?php echo $value['id'] ?>" <?php if($checkid){?> checked <?php } ?>  onClick="checks(<?php echo $userid ?>,<?php echo $value['id'] ?>,'<?php echo $eid; ?>')"><a href="#"><?php echo $value['menu_name']; ?></a>
                    ...
                    <ul>
                      ...
                      <?php
						 ...
						 {
                          $checkid1= $this->base_model->check_menu($userid,$value1['id'],$eid);
							 ?>

                        <li><a href="#"><input  type="checkbox" id="<?php echo $value1['id'] ?>" <?php if($checkid1){?> checked <?php } ?> onClick="checks(<?php echo $userid ?>,<?php echo $value1['id'] ?>,'<?php echo $eid; ?>')"><?php echo $value1['menu_name']; ?></a>
                            ...
                            if(count($value1['subchild'])!=0)
							  ...
							  {
                              $checkid2= $this->base_model->check_menu($userid,$value2['id'],$eid);
							  ?>

                                <li><a href="#"><input type="checkbox"  id="<?php echo $value2['id']; ?>" <?php if($checkid2){?> checked <?php } ?>  onClick="checks(<?php echo $userid ?>,<?php echo $value2['id'] ?>,'<?php echo $eid; ?>')"><?php echo $value2['menu_name']; ?></a>
						            ...
						            foreach($value2['subsubchild'] as $key3=>$value3)
							         ...
							         {
                                     $checkid3= $this->base_model->check_menu($userid,$value3['id'],$eid);
							         ?>

                                     <li><a href="#"><input  type="checkbox" id="<?php echo $value3['id'] ?>" <?php if($checkid3){?> checked <?php } ?>  onClick="checks(<?php echo $userid ?>,<?php echo $value3['id'] ?>,'<?php echo $eid; ?>')"><?php echo $value3['menu_name']; ?></a></li>
...
//////////////////////////////////////////////////////////////active deactive menu
	...
	function checks(user,str,eid)
		...
		$.post("<?php echo base_url(); ?>index.php/admin/usermenugetdata",{devalue:strall},function(data)
        {
            alert(5);
		...
		$.post("<?php echo base_url(); ?>index.php/admin/usermenugetdata",{value:strall},function(data)
        {
            alert(strall);
       // $(".page-sidebar-menu").load(location.href + " .page-sidebar-menu");
        });
