...
<p class=" text-info" style="font-size: larger;"><?php echo date('d M').','.date('Y').','.date('h:i:s'); ?></p>
                    ...
                    <tbody>
					  ...
					  <tr>
                       ...
                       <tr>
                        ...
                        <td><input type="text" class="form-control" id="regdate" name="date" value="<?php echo $userview[0]->date;?>" placeholder="Regsitration Date."></td>
                      </tr>
					  <tr>
 ...
 <tr>
                        <td>Opening Quantity Balance:</td>
                        <td><input type='number' class="form-control" id="opening_balance_quantity" name="opening_balance_quantity" value="<?php echo $userview[0]->opening_balance_quantity;?>" placeholder="Opening Balance Quantity."></td>
                      </tr>
					  <tr>
