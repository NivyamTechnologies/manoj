...
<div class="page-container">
	...
	<div class="page-content-wrapper">
        ...
        <?php } ?>  
								...
								<div class="btn-group">
	<form name="serach" action="<?php echo base_url() ?>admin/viewdistributer" method="POST">
						<table>
						<tr>
                        <td style="padding-right: 25px;">
						  ...
						  <td><a href="<?php echo base_url(); ?>admin/export_alluser<?php echo $kk; ?>" class="btn btn-primary">Export In Excel</a></td>
							...
							<tr>								
								...
								<td>
								<a class="btn bg-primary wnm-user" href="<?php echo base_url(); ?>admin/usersubview/<?php echo $r->member_id; ?>">
								View
							    </a> &nbsp; &nbsp;
							    </td>
