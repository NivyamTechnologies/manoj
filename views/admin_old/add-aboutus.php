...
<div class="page-container">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/aboutus/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				<?php				
				foreach($viewaboutinfo as $userdata)
						{
							$about_desc = $userdata->about_desc;							
							
						}
				?>
				                                                   
											<div class="form-body">
												<h3 class="form-section">About Us Info</h3>
...
<textarea name = "about_desc" cols=50 class="form-control" id="about_desc"  rows=5 style="margin: 0px -443.078px 0px 0px; width: 774px; height: 145px;">
<?php echo $about_desc;?>
</textarea>
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													{
														?>
												<input type="submit" name="about_update" class="btn green" value="Update"/>
															<?php
													}else{?>
													<input type="submit" name="about_update" value="Submit" class="btn green"/>
														<?php
													}?>
