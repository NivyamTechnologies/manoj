...
<div class="page-container">
	...
	<div class="page-content-wrapper">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url('admin/addledger');?>">
								Ledger
							</a>
        ...
        <?php } ?>  
								...
								<input type="text" id="bvmbranchname" name="bvmlandlordname" class="form-control" placeholder="Enter Land Lord Name" autocomplete="off" value="<?php echo $branchdata[0]->bvmlandlordname; ?>"/>																
															</div>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" name="father_name" id="father_name" class="form-control" placeholder="Enter FirstName"  autocomplete="off" value="<?php echo $branchdata[0]->father_name; ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">3. Date Of Birth</label>
															<div class="col-md-8">
															
						<input type="text" id="applicant_dob" name="applicant_dob" class="form-control" placeholder="Enter Date of Birth" readonly  autocomplete="off" value="<?php echo $branchdata[0]->applicant_dob; ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">4. E-mail ID</label>
															<div class="col-md-8">
																<input type="text" id="bvmpuc_email" name="bvmpuc_email" class="form-control" placeholder="Enter Email Id"  autocomplete="off" value="<?php echo $branchdata[0]->bvmpuc_email; ?>"/>				
												...
												<div class="row">
                                                   ...
                                                   <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">8. Tehsil</label>
															<div class="col-md-8">
                                                   ...
                                                   <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">10. Mobile No.</label>
															<div class="col-md-8">
                                                   ...
                                                   <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
										<label class="control-label col-md-4">14. Land Area Sq</label>

															<div class="col-md-8">

				<input type="text" id="land_area" name="land_area" class="form-control" placeholder="Enter Land Area Square" value="<?php echo $branchdata[0]->land_area;?>"/>
