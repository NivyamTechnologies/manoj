...
<div class="page-container">
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addproduct/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				...
				foreach($viewproductinfo as $userdata)
						{
							...
							$product_desc = $userdata->product_desc;
		  ...
		  echo form_dropdown('category',$category,$categoryid,'class="form-control" id="category" required'); ?>
										...
										<div class="col-md-8">
											<input type="text" name="product_name" class="form-control" required id="exampleInputEmail1" value="<?php echo $product_name;?>" placeholder="Enter text">
														...
														<div class="col-md-6">
														<div class="form-group">
							<label class="control-label col-md-4">Product Desc</label>
															
										<div class="col-md-8">
											<input type="text" name="product_desc" class="form-control" required id="product_desc" value="<?php echo $product_desc;?>" placeholder="Enter Product Desc">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Product BV</label>
															
										<div class="col-md-8">
											<input type="text" name="product_bv" class="form-control" id="exampleInputEmail1" value="<?php echo $product_bv;?>" placeholder="Enter text">
														...
														<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Product DP</label>
															
										<div class="col-md-8">
											<input type="text" name="product_dp" class="form-control" id="exampleInputEmail1" value="<?php echo $product_dp;?>" placeholder="Enter text">
										...
										<div class="col-md-8">
											<input type="text" name="product_price" class="form-control" id="exampleInputEmail1" value="<?php echo $product_price;?>" placeholder="Enter text">
												...
												<div class="row">
													...
													if($this->uri->segment(3)!='')
													{
														...
														<?php
															...
															<a class="btn btn default" href="<?php echo base_url()?>admin/product">Cancel</a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
