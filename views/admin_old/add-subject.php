...
<div class="page-container">
			...
			<div class="row">
				...
				?>					
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addsubject/'.$this->uri->segment(3)); ?>
    ...
    <?php } ?>  
				<?php				
				foreach($viewsubjectinfo as $userdata)
						{
				...
				?>
											...
											<div class="form-body">
												<h3 class="form-section">Subject Info</h3>
		  ...
		  echo form_dropdown('class',$class,$set_class,'class="form-control" id="session"'); ?>
										...
										<div class="col-md-9">
											<input type="text" name="subject_name" class="form-control" id="exampleInputEmail1" value="<?php echo $subject_name;?>" placeholder="Enter text">
											<?php echo form_error('subject_name','<p style="color:#F83A18">','</p>'); ?>
										</div>
									</div>
														</div>
										...
										<div class="col-md-9">
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													{
														?>
															<button type="submit" name="subject_update" class="btn green">Update</button>
															<?php
													}else{?>
														<button type="submit" class="btn green">Submit</button>
														<?php
													}?>
															<a class="btn btn default" href="<?php echo base_url()?>admin/subject">Cancel</a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
