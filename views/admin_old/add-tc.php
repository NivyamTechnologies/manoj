...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/addtc">
							Transaction
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addtc/'); ?>
    ...
    <?php } ?>  
				...
				?>
						...
						<label class="control-label col-md-4">Enter From ID</label>
                                <div class="col-md-6">
		...
		<label class="control-label col-md-4">Contra By</label>
		...
		$option = array('cash' =>'By Cash','btb'=>'Bank To Bank','btc'=>'Bank To Cash','ctb'=>'Cash To Bank');
		...
		<div class="col-md-4" id ='bnk'style="display:none">
		<div class="form-group">
	    ...
	    <div class="col-md-4" style="display:none" id ='bnk1'>
		<div class="form-group">
		<label class="control-label col-md-4">Bank To</label>													
		<div class="col-md-6">
		<?php 
		...
		if(isset($_POST['bank']))
		{
		  ...
		  echo form_dropdown('banks1',['Select']+$banks,$bankid,'class="form-control" style="display:none" id="bank1" required'); ?>	
							...
							<div class="col-md-8">
							<input type="text" name="narration" id="narration" style="display:none" class="form-control"/>
							...
							<div class="col-md-8">
							<input type="text" name="amount" id="amount" style="display:none" class="form-control"/>
