...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				...
				<div class="col-md-12">
								...
								<div class="portlet box green">
									...
									<div class="portlet-title">
										...
										<div class="caption">
											...
											<i class="fa fa-reorder"></i>Template
					...
					<?php echo form_open_multipart('admin/addtemplate'); ?>
    ...
    <?php } ?>  
				...
				foreach($viewtemplateinfo as $userdata)
				...
				?>
											...
											<div class="form-body">
												...
												<h3 class="form-section">Template Info</h3>
												...
												<div class="row">
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<label class="control-label col-md-4">Template Title</label>
												...
												<div class="row">
...

													{
														...
														?>
															...
															<button type="submit" name="template_update" class="btn green">Update</button>
									...
									<a class="btn btn default" href="<?php echo base_url()?>admin/template">Cancel</a>
