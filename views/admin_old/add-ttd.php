...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/ttdv">
							Transfer
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('admin/addttd/'); ?>
    ...
    <?php } ?>  
				...
				?>
								...
								<label class="control-label col-md-4">Depo Login ID</label>
                                <div class="col-md-6">
								<input type="text" id="branch_id" name="branch_id" class="form-control" required onchange="getdepodata(this.value)"/>
								</div>
						...
						<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">2. Depo Name:</label>
										<div class="col-md-8">
...
<script>
function getdepodata(str)
{
jQuery.post("<?php echo base_url();  ?>admin/getdepodata", {no: str}, function(result){
  ...
  quantity =$("#qty").val();
  if(quantity > $("#product_quantity"+pid).val())
  {
