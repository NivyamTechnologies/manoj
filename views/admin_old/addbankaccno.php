...
<div class="page-container">
  ...
  <?php 
		if ($this->session->flashdata('success1')) 
		{
		 ...
		 ?>                                            
    <div class="form-body">
        <h3 class="form-section">ADD Bank Account No  </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8"> Bank Account No:</label>
                    <div class="col-md-10">
                        <input type="text" name="bank_accno" id="bank_accno" class="form-control" placeholder="Enter No"    />
			 ...
			 <div class="col-md-6">
			 <div class="form-group">
			 <label class="control-label col-md-8">Bank Name.</label>
                        <div class="col-md-10">
			 ...
			 <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8">Ifsc Code:</label>
                    <div class="col-md-10">
                        <input type="text" name="bank_ifsc_code" id="bank_ifsc_code" class="form-control" placeholder="Enter Code"    />
