...
<div class="page-container">
  ...
  <?php 
		if ($this->session->flashdata('success1')) 
		{
		 ...
		 ?>                                            
    <div class="form-body">
        <h3 class="form-section">Add Level </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
			  ...
			  <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8"> Level Name:</label>
                    <div class="col-md-10">
						...
						<option value="MOBILE Achiever">MOBILE Achiever</option>
						<option value="Gold Leaders">Gold Leaders</option>
						<option value="Star Gold Leaders">Star Gold Leaders</option>
						<option value="Platinum Leaders">Platinum Leaders</option>
						<option value="Star Platinum Leaders">Star Platinum Leaders</option>
						<option value="Opel Leaders">Opel Leaders</option>
						<option value="Diamond Leaders">Diamond Leaders</option>
						<option value="Star Diamond">Star Diamond</option>
						<option value="Crown Diamond">Crown Diamond</option>
						<option value="Star Crown Diamond">Star Crown Diamond</option>
						<option value="Universal Diamond">Universal Diamond</option>
						</select>
