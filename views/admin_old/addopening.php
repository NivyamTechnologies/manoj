...
<div class="page-container">
  ...
  <?php 
		if ($this->session->flashdata('success1')) 
		{
		 ...
		 ?>                                            
    <div class="form-body">
        <h3 class="form-section">ADD Opening Balance  </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-8"> Opening Balance:</label>
                    <div class="col-md-10">
                        <input type="text" name="balance" id="balance" class="form-control" placeholder="Enter Amount"    />
