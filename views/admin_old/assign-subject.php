...
//Get Sub Categories on change of Categories
    $('#catid').change(function() 
	{
   	...
   	if(catid=="") {
   		$('#subjectid').empty();
   		$('#subjectid').append("<option value=''>Select Class First.</option>");
   	}
   	...
   	$.ajax({
		...
		{	
   			...
   			if (dta.length!=null) 
			{
				...
				{
				val1=dta[i].split('_');
   				$('#subjectid').append("<option value='"+val1[0]+"'>"+val1[1]+"</option>");
				}
   			}	
			}
   		}
...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Assign Subject <small>Details</small>
					</h3>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<form method="POST" name="assignsubjectform" id="assignsubjectform" action="<?php echo base_url();?>admin/addassignsubject" enctype="multipart/form-data">
         <?php if(count($data)>0)
            $data=$data[0];
            ?> 
    ...
    <?php } ?>  
				...
				foreach($viewassignsubjectinfo as $userdata)
						{
				...
				?>
											...
											<div class="form-body">
												<h3 class="form-section">Assign Subject Info</h3>
               ...
               echo form_dropdown('catid', $class, $val,'class="form-control" id="catid"');
               ?>
            ...
            <select name="subjectid" id="subjectid" class="form-control">
               <option value="<?php echo $val;?>"><?php echo $name;?></option>
										...
										<div class="col-md-8">
											<?php 		  
		  echo form_dropdown('teacher',$teacher,$teacher_name,'class="form-control" id="teacher"'); ?>
										
											<?php echo form_error('teacher','<p style="color:#F83A18">','</p>'); ?>
											...
											<div class="form-actions fluid">
												<div class="row">
													...
													{
														?>
															<button type="submit" name="assignsubject_update" class="btn green">Update</button>
															<?php
													}else{?>
														<button type="submit" class="btn green">Submit</button>
														<?php
													}?>
															<a href="<?php echo base_url()?>admin/assignsubjectdetails" class="btn">Cancel</a>
														</div>
													</div>
													<div class="col-md-6">
													</div>
