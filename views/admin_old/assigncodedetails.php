...
<a href="<?php echo base_url()?>admin/generatediscountcode"><button class="btn green">Add New <i class="fa fa-plus"></i></button></a>
				...
				<?php } ?>					
							...
							<?php if(count($Allassigncode)>0) { 

					$i=1;

					foreach($Allassigncode as $r)

					{

						$set_class = $r->class;

						$set_coaching = $r->coaching;
...
<?php echo $r->amount;?>
								...
								<td>
									...
									<?php 
									$qq=$this->base_model->get_class($r->class);
								...
								<td>
<?php 
									$q2=$this->base_model->get_coaching($r->class);
								...
								?>
									...
									<a class="btn bg-primary wnm-user" href="<?php echo base_url()?>admin/generatediscountcode/<?php echo $r->id;?>">
								...
								?>
									...
									<a href="<?php echo base_url();?>admin/deletediscountcode/<?php echo $r->id;?>" onclick="return confirm('Are you sure you want to delete this AssignSubject?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i> Delete</a>
