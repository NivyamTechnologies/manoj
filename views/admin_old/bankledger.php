  ...
  <div class="col-12">
    ...
    <div class="table-toolbar">
        ...
        <select class="form-control" id="year" name="year">
		  ...
		  <option value="2019" <?php echo ($year==2018)?'selected':''; ?>>2019</option>
        </select>
        </td> 
        ...
        <div class="btn-group">
            ...
            <table id="myTable" style="border: 2px solid black"  class="table table-striped table-hover table-bordered">
              ...
              <tbody> 
              <?php foreach($bank2ledger as $bank2ledger){ ?>
			 
                <tr> 
				<td  style="border: 2px solid black" ><?php echo $bank2ledger->date;?></td>
                  <td  style="border: 2px solid black" ><?php echo $bank2ledger->recid;?></td>
				  <td style="border: 2px solid black" ><?php echo $bank2ledger->narration;?></td>
				    <td style="border: 2px solid black" ><?php echo $bank2ledger->payment;?></td>
					 <td style="border: 2px solid black"><?php echo $bank2ledger->amount;?></td>
                      
                     <?php $totolfinal =  $totolfinal+( $bank2ledger->amount-(isset($bank2ledger->payment)  ? $bank2ledger->payment : 0));?>
