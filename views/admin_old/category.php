...
<a href="<?php echo base_url()?>admin/addcategory"><button class="btn green">Add New <i class="fa fa-plus"></i></button></a>
        ...
        <img src="<?php echo base_url().'assets/img/avatar.png'?>" height="70px;" width="100px;"/>      							
         <?php }
									  elseif($r->category_image!='')
									  { ?>
		 <a href="<?php echo base_url().'categoryimage/'.$r->category_image;?>"><img src="<?php echo base_url().'categoryimage/'.$r->category_image;?>" height="70px;" width="100px;"/></a>
								<?php } ?>   
								</td>								
								<td>
