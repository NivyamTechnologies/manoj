...
<a href="<?php echo base_url()?>admin/addttd"><button class="btn green">Add New <i class="fa fa-plus"></i>
</button></a>
							...
							<tr>								
                               ...
                               <td>
								...
								<td>
								<a href="<?php echo base_url();?>admin/depochalanview/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
							    </td>
