        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								{
								?>
								<a href="<?php echo base_url();?>admin/deletebill/distributor/<?php echo $r->chalan_id;?>/distchalanviewCGST" onclick="return deletebill()">Delete</a>
							     <?php }
								elseif($r->billfromtype==2)
								{
									$createb=$this->db->query("select applicant_no from mlm_members_login where member_id='".$r->createby."'")->row();
								?>
								<a href="<?php echo base_url();?>admin/deletebillall/<?php echo $r->branch_id;?>/<?php echo $createb->applicant_no; ?>/distributor/<?php echo $r->chalan_id;?>/distchalanviewCGST" onclick="return deletebill()">Delete</a>
