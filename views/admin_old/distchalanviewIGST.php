        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								{
								?>
								<a href="<?php echo base_url();?>admin/deletebill/distributor/<?php echo $r->chalan_id;?>/distchalanviewIGST" onclick="return deletebill()">Delete</a>
							     <?php }
								elseif($r->billfromtype==2)
								{
								?>
								<a href="<?php echo base_url();?>admin/deletebillall/<?php echo $r->branch_id; ?>/<?php echo $createb->applicant_no; ?>/distributor/<?php echo $r->chalan_id;?>/distchalanviewIGST" onclick="return deletebill()">Delete</a>
