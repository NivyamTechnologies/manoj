    ...
    <?php } ?>  
				...
				?>
							...
							<tr>
								...
								<td>
									<?php echo "<p style='background-color: darkred; width:40px;'>$remainingfee</p>"?>
								</td>
								<td>
		...
		<img src="<?php echo base_url().'studentimage/'.$r->student_image;?>" height="50px;" width="50px;"/>	  
								...
								{
								?>
									<a href="<?php echo base_url()?>admin/feeedit/<?php echo $r->aid;?>" class="btn bg-primary wnm-user">
										 Edit
									</a>
								<?php }?>
								</td>								
