    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
            ...
            <table id="myTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
              <?php foreach($levellist as $levellist){ ?>
                <tr>
                    <td><?php echo $levellist->level_id;?></td>
                    <td><?php echo $levellist->level_name;?></td>
                    <td><?php echo $levellist->applicant_no;?></td>
					 <td><?php echo $levellist->month;?></td>
