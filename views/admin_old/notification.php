		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Notification<small>Detail</small>
					</h3>
...
<a href="<?php echo base_url()?>admin/addnotification"><button class="btn green">Add New <i class="fa fa-plus"></i></button></a>
					...
					{
						$dateofpost = date_create($r->post_date);
						$post_date = date_format($dateofpost,"d-M-Y");
						$dateoflast = date_create($r->last_date);
				...
				?>
							...
							<tr>								
								...
								<td>
									<a class="btn bg-primary wnm-user" href="<?php echo base_url()?>admin/addnotification/<?php echo $r->id;?>">
										 Edit
									</a>
								</td>
								<td>
									<a href="<?php echo base_url();?>admin/notification/<?php echo $r->id;?>" onclick="return confirm('Are you sure you want to delete this notification?')" class="btn bg-primary wnm-user"><i class="fa fa-times-circle"></i>Delete</a>
								</td>
							</tr>
