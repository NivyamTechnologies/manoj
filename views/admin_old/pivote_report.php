    ...
    <div class="table-toolbar">
						...
						<tr>
							...
							<td style="padding-right: 25px;">
								<select class="form-control" id="year" name="year">
								  ...
								  <option value="2018" <?php echo ($year==2019)?'selected':''; ?>>2019</option>
								</select>
							</td> 
        ...
        <div class="btn-group">
            <table id="mypivotTable" class="table table-striped table-hover table-bordered">
              ...
              <tbody>
				<?php 
				foreach($pivote_report as $key => $report){ if($report->slab==0){ continue; } ?>
					<tr>
						<td><?php echo $report->applicant_no;?></td>
						<td><?php echo $report->slab;?></td>
