    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
            ...
            <table id="myTable" style="border: 2px solid black"  class="table table-striped table-hover table-bordered">
              ...
              <tbody> 
              <?php foreach($pucledger as $pucledger){ ?>
			  <?php $totolfinal =  $totolfinal+( $pucledger->totaldp-(isset($pucledger->amount)  ? $pucledger->amount : 0));?>
                <tr> 
				<td  style="border: 2px solid black" ><?php echo date("Y-m-d",strtotime($pucledger->datetime));?></td>
                  <td  style="border: 2px solid black" >  <?php echo (is_numeric($pucledger->createby))? $this->base_model->getpucbranchname($pucledger->createby) :$pucledger->createby ;?></td>
				  <td style="border: 2px solid black" ><?php echo 'BVM/'.getfin($pucledger->datetime).'/'.$pucledger->s_no;?></td>
				    <td style="border: 2px solid black" ><?php echo $pucledger->totaldp;?></td>
					 <td style="border: 2px solid black"><?php echo $pucledger->amount;?></td>
