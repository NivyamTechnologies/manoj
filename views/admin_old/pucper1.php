           ...
           <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
							...
							<tr>								
                               ...
                               <td>
								...
								<input type="hidden" value="<?php echo $r->distributor_id;?>" name="ApplicantNo[]">
								 <td>
								<?php echo $r->applicant_name;?>
								</td>
								<input type="hidden" value="<?php echo $month;?>" name="month">
                        <input type="hidden" value="<?php echo $year;?>" name="year">
				    <input type="hidden" value="<?php echo puc_commision;?>" name="report_filter">
								 <td>
								...
								<td> <?php echo $r->percentageValue	;?></td>
								<td> <?php  
								if( $r->totaldp>=50000 && $r->totaldp<200000){
								echo ($r->totaldp*($r->percentageValue+1))/100;
								$total=($r->totaldp*($r->percentageValue+1))/100;}
								else if( $r->totaldp>=200000){
									echo ($r->totaldp*($r->percentageValue+2))/100;
									$total=($r->totaldp*($r->percentageValue+2))/100;}
								else{
								echo $r->TotalAmount;
								$total=$r->TotalAmount;}
								?>
