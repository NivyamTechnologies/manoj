		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Purchase Chalan IGST List
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						
						<li>
							<i class="fa fa-home"></i>
							<a href="<?php echo base_url();?>admin/purchasechalanviewIGST">
								Purchase Chalan
							</a>
        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								<a href="<?php echo base_url();?>admin/purchasechalanIGST/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
								<?php }elseif($r->chalantype == 2){?>
								<a href="<?php echo base_url();?>admin/purchasechalanCGST/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
							    <?php } ?>
							    </td>
								<td>
								<a href="<?php echo base_url();?>admin/deletebill/purchase/<?php echo $r->chalan_id;?>/purchasechalanviewIGST" onclick="return deletebill()">Delete</a>							    
								</td>
