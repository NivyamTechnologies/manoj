...
<div class="page-container">
  ...
  <div class="col-12">
    ...
    <div class="table-toolbar">
        ...
        <div class="btn-group">
			<form id="process_pivot" method="post">
            <table id="mypivotTable" class="table table-striped table-hover table-bordered">
              <thead>
                <tr id="pivotTR">
                    <td> No.</td>
                    <td>Jan</td>
              ...
              <tbody>
				...
				foreach($pivotlists as $key => $pivotlist){  if (!in_array($pivotlist->applicant_no, $all_applicant_no)){ continue; } ?>
					<tr>
						<td><?php echo $pivotlist->applicant_no;?></td>
						<td style="background-color:<?php echo $color[($pivotlist->jan==null)?3:$pivotlist->jan];?>;"><?php echo $dplistTargetdata[$key]->jan;?></td>
						<td style="background-color:<?php echo $color[($pivotlist->feb==null)?3:$pivotlist->feb];?>;"><?php echo $dplistTargetdata[$key]->feb;?></td>
						<td style="background-color:<?php echo $color[($pivotlist->mar==null)?3:$pivotlist->mar];?>;"><?php echo $dplistTargetdata[$key]->mar;?></td>
						<td style="background-color:<?php echo $color[($pivotlist->apr==null)?3:$pivotlist->apr];?>;"><?php echo $dplistTargetdata[$key]->apr;?></td>
						<td style="background-color:<?php echo $color[($pivotlist->may==null)?3:$pivotlist->may];?>;"><?php echo $dplistTargetdata[$key]->may;?></td>
						<?php if($month >= 6){ ?>
							<td style="background-color:<?php echo $color[($pivotlist->jun==null)?3:$pivotlist->jun];?>;"><?php echo $dplistTargetdata[$key]->jun;?></td>
						 <?php } 
						if($month >= 7){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->jul==null)?3:$pivotlist->jul];?>;"><?php echo $dplistTargetdata[$key]->jul;?></td>
						 <?php } 
						if($month >= 8){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->aug==null)?3:$pivotlist->aug];?>;"><?php echo $dplistTargetdata[$key]->aug;?></td>
						 <?php } 
						if($month >= 9){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->sep==null)?3:$pivotlist->sep];?>;"><?php echo $dplistTargetdata[$key]->sep;?></td>
						 <?php } 
						if($month >= 10){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->oct==null)?3:$pivotlist->oct];?>;"><?php echo $dplistTargetdata[$key]->oct;?></td>
						 <?php } 
						if($month >= 11){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->nov==null)?3:$pivotlist->nov];?>;"><?php echo $dplistTargetdata[$key]->nov;?></td>
						 <?php } 
						if($month >= 12){ ?>
						<td style="background-color:<?php echo $color[($pivotlist->decm==null)?3:$pivotlist->decm];?>;"><?php echo $dplistTargetdata[$key]->decm;?></td>
						<?php } ?>
						<td><input style="width:60px;" type="text" name="slab[<?php echo $pivotlist->applicant_no; ?>]" value="<?php echo ($iscomplete[$pivotlist->applicant_no]==1)?$all_target[$pivotlist->applicant_no]:""; ?>">
						</td>
						<td><?php echo ($iscomplete[$pivotlist->applicant_no]==1)?"Completed":"Incomplete"; ?></td>
					</tr>
                <?php } ?>
                </tbody>
                </table> 
    ...
    <script>
        jQuery(document).ready(function() {    
           ...
           $("#process").click(function(){
			...
			var count = $("#pivotTR td").length-1;
			$('#mypivotTable').DataTable({
				"bPaginate": false,
				"order": [[ count, "asc" ]]
			});
        });
