...
<div class="page-container">
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/sessionwise">
								Session 
							</a>
    ...
    <?php } ?>  
							<div class="table-toolbar">
								<div class="btn-group">
				<?php echo form_open_multipart('admin/sessionwise'); ?>
										<table width="800">
                    <tr><td>
                    <div class="col-md-8">
		  ...
		  echo form_dropdown('session',$session,$session_name,'class="form-control" id="session"'); ?>
									</div>
					...
					foreach($Allstudent as $r)
					{
						...
						$student_session = $r->admission_session;
