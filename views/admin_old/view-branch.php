...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="col-md-12">
					...
					<form name="registration" id="registration" action="" method="POST" enctype="multipart/form-data">
								...
								<label class="control-label col-md-4">1. Distributor ID</label>
														...
														<div class="col-md-8">
																<input type="text" id="distributor_id" name="distributor_id" class="form-control" value="<?php echo $branchdata[0]->distributor_id; ?>" disabled onchange="getsn(this.value)"/>

								<input type="hidden" name="applicant_no" id="applicant_no"  class="form-control" placeholder="Enter Name" value="<?php echo $branchdata[0]->applicant_no; ?>" disabled autocomplete="off" />
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="bvmbranchname" name="bvmbranchname" class="form-control" placeholder="Enter Branch Name"  disabled autocomplete="off" value="<?php echo $branchdata[0]->bvmbranchname; ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="address" name="address" class="form-control" placeholder="Enter your Postal Address" disabled   autocomplete="off" value="<?php echo $branchdata[0]->address; ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="landmark" name="landmark" class="form-control" placeholder="Enter Near Landmark"  disabled autocomplete="off" value="<?php echo $branchdata[0]->landmark; ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
															<input type="text" id="landmark" name="landmark" class="form-control" placeholder="Enter Near Landmark"  disabled autocomplete="off" value="<?php echo $branchdata[0]->state; ?>"/>
															</div>
														</div>
													</div>
													</div><br/>
												...
												<div class="row">
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
															<input type="text" id="landmark" name="landmark" class="form-control" placeholder="Enter Near Landmark"  disabled autocomplete="off" value="<?php echo $branchdata[0]->districtname; ?>"/>
															</div>
														</div>		
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="city" name="city" class="form-control" placeholder="Select city"  disabled autocomplete="off" value="<?php echo $branchdata[0]->city;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="pincode" name="pincode" class="form-control" placeholder="Enter Pincode"   disabled autocomplete="off" value="<?php echo $branchdata[0]->pincode;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="mobno" name="mobno" class="form-control" placeholder="Enter Mobile" disabled  autocomplete="off" value="<?php echo $branchdata[0]->mobno;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="rentfixed" name="rentfixed" class="form-control" placeholder="Enter Rent" disabled  autocomplete="off" value="<?php echo $branchdata[0]->rentfixed;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="securitydeposit" name="securitydeposit" class="form-control" disabled placeholder="Enter Security Deposit"   autocomplete="off" value="<?php echo $branchdata[0]->securitydeposit;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="creditlimit" name="creditlimit" class="form-control" placeholder="Enter Credit"  disabled autocomplete="off" value="<?php echo $branchdata[0]->creditlimit;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="commisiononpuc" name="commisiononpuc" class="form-control" placeholder="Enter Commission" disabled  autocomplete="off" value="<?php echo $branchdata[0]->commisiononpuc;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="commisionondistributor" name="commisionondistributor" class="form-control" placeholder="Enter Commission"  disabled autocomplete="off" value="<?php echo $branchdata[0]->commisionondistributor;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="nearesrdepo" name="nearesrdepo" class="form-control" placeholder="Enter Nearest Depo"   disabled autocomplete="off" value="<?php echo $branchdata[0]->nearesrdepo;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="gstno" name="gstno" class="form-control" placeholder="Enter GST" disabled   autocomplete="off" value="<?php echo $branchdata[0]->gstno;  ?>"/>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="file" id="bankdetailproofdoc" name="bankdetailproofdoc" disabled class="form-control"/>
															</div>
														</div>
                                                    </div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="rentlandloard" name="rentlandloard" class="form-control" disabled placeholder="Enter Landlord Name"   autocomplete="off" value="<?php echo $branchdata[0]->rentlandloard;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="rentfathername" name="rentfathername" class="form-control" disabled placeholder="Enter FirstName"   autocomplete="off" value="<?php echo $branchdata[0]->rentfathername;  ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="rentaccno" name="rentaccno" disabled class="form-control" placeholder="Enter Account Number"   autocomplete="off" value="<?php echo $branchdata[0]->rentaccno;  ?>"/>
												...
												<div class="row">
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="rentifsc" name="rentifsc" disabled class="form-control" placeholder="Enter IFS Code"   autocomplete="off" value="<?php echo $branchdata[0]->rentifsc;  ?>"/>
			...
			<input type="text" id="bvmpuc_distributor" name="bvmpuc_distributor" class="form-control" disabled value="<?php echo $branchdata[0]->bvmpuc_distributor; ?>"  onchange="getpsn(this.value)"/>	
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">2. Name of the Applicant:</label>
															<div class="col-md-8">
																<input type="text" id="bvmpuc_aplicantname"  disabled name="bvmpuc_aplicantname" class="form-control" placeholder="Enter Name" disabled  autocomplete="off" value="<?php echo $branchdata[0]->bvmpuc_aplicantname;  ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
				<input type="text" id="bvmpuc_email" name="bvmpuc_email" class="form-control" disabled placeholder="Enter E-mail id" disabled  value="<?php echo $branchdata[0]->bvmpuc_email;  ?>"/>
															</div>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																...
																<input type="text" id="bvmpuc_state" disabled name="bvmpuc_state" class="form-control" placeholder="Select City" disabled autocomplete="off" value=""/>
												...
												<input type="text" id="bvmpuc_city"  disabled name="bvmpuc_city" class="form-control" placeholder="Select City" disabled autocomplete="off" value=""/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
															<input type="text" id="bvmpuc_dist" disabled name="bvmpuc_dist" class="form-control" placeholder="Select Distt" disabled autocomplete="off" value=""/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="bvmpuc_mobno" disabled name="bvmpuc_mobno" class="form-control" placeholder="Enter Mobile" disabled  autocomplete="off" value="<?php echo $branchdata[0]->bvmpuc_mobno;  ?>"/>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="bvmpuc_gurntamount" disabled name="bvmpuc_gurntamount" class="form-control" placeholder="Enter Guarantee Amount"   autocomplete="off" value="<?php echo $branchdata[0]->bvmpuc_gurntamount;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="bvmpuc_leadercommision"  disabled name="bvmpuc_leadercommision" class="form-control" placeholder="Enter Leader Commission"   autocomplete="off" value="<?php echo $branchdata[0]->bvmpuc_leadercommision;  ?>"/>
									...
									<label class="control-label col-md-4">10.Submit ID Proof</label>
															<div class="col-md-8">
																<input type="file" id="bvmpuc_submitid" disabled name="bvmpuc_submitid" class="form-control"/>
															</div>
														</div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="file" id="bvmpuc_agreement" disabled name="bvmpuc_agreement" class="form-control"/>
															</div>
														</div>
                                                    </div>
												...
												<label class="control-label col-md-4">1. </label>
															<div class="col-md-8">
						                                    <input type="text" id="witness_name1" disabled name="witness_name1" class="form-control" placeholder="Enter Name"   autocomplete="off" value="<?php echo $branchdata[0]->witness_name1;  ?>"/>	
															</div>
														</div>
													</div>
											...
											<label class="control-label col-md-4">2. </label>
															<div class="col-md-8">
								<input type="text" id="witness_name2" name="witness_name2" disabled class="form-control" placeholder="Enter Witness Name"   value="<?php echo $branchdata[0]->witness_name2;  ?>"/>
												...
												<h3 class="form-section"></h3>
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="password" id="password" disabled name="password" class="form-control" placeholder="Enter password"   autocomplete="off" value="<?php echo $branchdata[0]->password;  ?>"/>
										...
										<div class="form-body">
												...
												<div class="row">
													...
													<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" id="witness_submitby1" disabled name="witness_submitby1" class="form-control" placeholder="Enter Name"   autocomplete="off" value="<?php echo $branchdata[0]->witness_submitby1;  ?>"/>
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">2. </label>
															<div class="col-md-8">
																<input type="text" id="witness_submitby2" disabled name="witness_submitby2" class="form-control" placeholder="Enter Name"   autocomplete="off" value="<?php echo $branchdata[0]->witness_submitby2;  ?>"/>
