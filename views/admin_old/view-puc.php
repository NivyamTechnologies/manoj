		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
				<?php if($update=='true'){ echo 'Edit';}?>	Puc 
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						
						<li>
							<i class="fa fa-home"></i>
							<a href="<?php echo base_url('admin/generatepuc');?>">
							<?php if($update=='true'){ echo 'Edit';}?>	PUC
							</a>
		...
		if ($this->session->flashdata('success')) 
		{
		 ...
		 ?>  
								...
								<input type="hidden" name="applicant_no" id="applicant_no"  class="form-control" placeholder="Enter Name" value="<?php echo $branchdata[0]->applicant_no; ?>" autocomplete="off" />
										...
										<div class="form-body">
												<h3 class="form-section">Information Related to BVM PUC & Security</h3>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
												...
												<div class="row">
                                                    ...
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">9. First Purchasing</label>
															<div class="col-md-8">
													...
													$proquan = $this->base_model->getprodctinfonew($branchdata[0]->applicant_no,$pro['id']);
													?>
													<div class="row">
													 <div class="col-md-6">
														<div class="form-group">
									                        <label class="control-label col-md-4">Product <?php echo $i; ?></label>
															<div class="col-md-8">
														    <input type="text" id="productname" name="productname[]" class="form-control" value="<?php echo $pro['product_name']; ?>" readonly/>
														    <input type="hidden" id="productname" name="productid[]" class="form-control" value="<?php echo $pro['id']; ?>"/>
														    </div>
														</div>
                                                    </div>
                                                     <div class="col-md-6">
														<div class="form-group">
									                    <label class="control-label col-md-4">Opening Quantity Balance</label>
														<div class="col-md-8">
													    <input type="number" id="opening_balance" name="opening_balance[]" class="form-control" value="<?php echo $proquan[0]['open_quantity'];  ?>"/>
														</div>
														</div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
														...
														<div class="col-md-8">
													    <input type="number" id="totalqun" name="totalqun[]" readonly class="form-control" value="<?php echo $proquan[0]['pucproductquantity'];  ?>"/>
														<input type="hidden" id="totalqun" name="opening_balanceexist[]" class="form-control" value="<?php echo $proquan[0]['open_quantity'];  ?>"/>
														</div>
														</div>
                                                    </div>
													</div>
			...
			<label class="control-label col-md-4">1. Royalty Achiver Distributer No.</label>
...
getpsn(<?php echo $branchdata[0]->distributor_id; ?>);	
});
