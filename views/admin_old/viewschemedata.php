				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>View Scheme Data
							</div>
    ...
    <?php } ?>  
				...
				?>
							...
							<tr>								
								...
								echo $this->base_model->getpucbranchname($r->createby)."(".$createb->applicant_no.")";
								?>
								</td>
                                <td>
								<?php
                                $otp = $this->db->query("select otpstatus,otp from scheme_process where scheme_id='".$r->schemeid."' and createby ='".$r->createby."'")->result_array();								
								echo $otp[0]['otp'];
								?>
								</td>
								<td>
                                 <?php 
								if($otp[0]['otpstatus']==1)
								{
								echo "Unused";	
								}
								elseif(!$otp[0]['otp'])
