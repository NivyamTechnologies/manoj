...
<div class="page-container">
    ...
    <?php } ?>  
				...
				?>
							...
							<tr>
								...
								<td>
									...
									if($remainingfee!='')
									{
						echo "<p style='background-color: white; width:40px;'>$remainingfee</p>";
									}else{?>
									<?php 
										echo "<p>Not Due</p>";
									} ?>
		...
		<img src="<?php echo base_url().'studentimage/'.$r->student_image;?>" height="50px;" width="50px;"/>	  
								...
								<td>
								<a href="<?php echo base_url()?>admin/user_menu_manage_sidebar/<?php echo $r->Stdid;?>/<?php echo $r->aid;?>" class="btn bg-primary wnm-user">
                                manage menu
							    </a>
