				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/addpucchalanCGST">
							Bill
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('branch/addpucchalanCGST/', array("id"=>"myform")); ?>
...
jQuery.post("<?php echo base_url();  ?>admin/getpucdata", {no: str}, function(result){
	...
	jQuery.post("<?php echo base_url();  ?>branch/getpucledgerdata", {no: str}, function(result){

        $fResult = result;
		alert("Ledger Amount " + result);	   
    });		
}

$('#myform').submit(function(e){
	var mytotal = parseInt($('#total').val());
	// if((parseInt($fResult)+mytotal) > 0){
	// 	e.preventDefault();
	// 	alert('Less than');
	// }
});
