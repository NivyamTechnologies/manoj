...
<title>Assurdness </title>
				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<a href="<?php echo base_url()?>admin/pucchalanIGST">
							Bill
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('branch/addpucchalanIGST/'); ?>
    ...
    <?php } ?>  
				...
				?>
								...
								<label class="control-label col-md-4">PUC Login ID</label>
                                <div class="col-md-6">
						...
						<div class="col-md-4">
									<div class="form-group">
					<label class="control-label col-md-4">2. PUC Name:</label>
										<div class="col-md-8">
...
{
jQuery.post("<?php echo base_url();  ?>admin/getpucdata", {no: str}, function(result){
	dataArray = jQuery.parseJSON(result);
       if(result=='1')
	   {
	   jQuery("#bvmbranchname").val('');
	   //jQuery("#creditlimit").val('');
	   alert("Distributor Id. not exist");	   
	   }
	   else
	   {
	   
	   jQuery("#bvmbranchname").val(dataArray[0].bvmbranchname);
  ...
  $( function() {
    ...
    $( "#productlist" ).autocomplete({
	 ...
	 productprice = ((product_mrp_price * 100)/(parseInt(product_taxrate)+100));
