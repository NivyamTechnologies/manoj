        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								<a href="<?php echo base_url();?>branch/branchchalanview/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
								...
								<?php if($r->receive == 0) {?>
								<td>
								<a href="<?php echo base_url(); ?>branch/receivequantity/<?php echo $r->chalan_id;?>/<?php echo $r->branch_id;?>">Receive</a>
								</td>
