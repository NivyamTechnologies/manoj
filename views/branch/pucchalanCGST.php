...
<div class="bs-example table-responsive">
    ...
    <h2 class="text-center">INVOICE</h2>
        ...
        <tr>
                 <td colspan="3">
				<?php echo $branchdetail[0]->bvmbranchname; ?>	<br/>
                <?php echo $branchdetail[0]->address; ?>	<br/>               
				</td>
				<td colspan="11">
				<table class="table">
				<tr>
             ...
             <tr>
                <td colspan="3">
				Transfer Details <br/>
                <?php  echo $branchdata[0]->bvmbranchname ?>(<?php  echo strtoupper($branchdata[0]->role); ?>)/<?php  echo $branchdata[0]->applicant_no; ?><br/>	
		...
		$i++;} ?>
            ...
            <tr>
                ...
                <td colspan="3"></td>
                <td colspan="8">For <?php echo $branchdetail[0]->bvmbranchname; ?></td>
            </tr>
