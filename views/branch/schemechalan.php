...
<div class="bs-example table-responsive">
    ...
    <h2 class="text-center">Bill of Supply(Scheme)</h2>
    
        <thead>
        <tr>
               <?php  
		$detail = $this->db->query("select applicant_no,role from mlm_members_login where applicant_no = '".$productlist[0]->branch_id."'")->result_array();
		...
		elseif($detail[0]['role']=='member')
		{
		$tbl = 'mlm_members_detail'; 	
		}
		...
		?>
                ...
                <td colspan="4">AMP<?php echo $productlist[0]->s_no;?></th>
				</tr>
				<tr>
                ...
                <td colspan="4"><?php echo date('d/m/Y',strtotime($productlist[0]->datetime));  ?></th>
								...
								<tr>
                <td colspan="3">Otp no-</th>
                <td colspan="4"><?php echo $productlist[0]->otp;  ?></th>
				</tr>
			    </table>
				</td>
            </tr>
             <tr>
                <td colspan="3">
				Transfer Details <br/>	
                <?php  echo $bpdetail[0]['bvmbranchname']; echo $bpdetail[0]['applicant_name']; ?>(<?php  echo strtoupper($detail[0]['role']); ?>)<br/>	
                <?php  echo $bpdetail[0]['address']; ?>(<?php echo $bpdetail[0]['applicant_no']; ?>)<br/>	
                Contcat:-<?php  echo $bpdetail[0]['mobno'];echo $bpdetail[0]['mobile_no'];  ?><br/>				
				</td>
                <td colspan="10"></td>
            </tr>
		...
		$i++;} ?>
            ...
            <tr>
           		<td>1</td>
                <td colspan="2" style="text-align:left">This Bill is only Scheme Bill.</td>
                <td colspan="3"></td>
