    ...
    <h2 class="text-center">INVOICE</h2>
        ...
        <tr>
             ...
             <tr>
                <td colspan="3">
				Transfer Details <br/>
                <?php  echo $branchdata[0]->applicant_name ?>  - <?php  echo   $branchdata[0]->applicant_no;?><br/>	
        ...
        $totaltaxcgst = $totaltaxcgst+$pro->cgst;
		$totaltaxsgst = $totaltaxsgst+$pro->sgst;
        $totalwithtax= $totalwithtax + $pro->total;
        $totalwithtax1= $productlist[0]->totaldp;
		$i++;} ?>
            ...
            <tr>
                ...
                <td><?php echo round($totaltaxsgst); ?></td>
            ...
            <tr>
                <td colspan="11" style="text-align:left">Discount :-</td>
                <td colspan="3"><?php echo ($totalwithtax-$totalwithtax1)   ; ?></td>
            </tr>
            <tr>
                <td colspan="3" style="text-align:left">Amount in Words :-</td>
                <td colspan="11"><?php echo strtoupper(numberTowords(round($totalwithtax1))); ?></td>
            </tr>
            
             <tr>
                <td colspan="5" style="text-align:left">Bv :<?php echo $productlist[0]->totalbv; ?></td>
                <td colspan="4">Grand Total : </td>
                <td colspan="5"><?php echo round($totalwithtax1); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3"></td>
                <td colspan="8">For <?php echo $pucdata[0]->bvmbranchname; ?></td>
            </tr>
