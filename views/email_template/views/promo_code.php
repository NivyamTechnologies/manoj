...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ITVARNEWS Promo Code for Segments</title>
                                                        ...
                                                        <table class="six columns">
                                                            <tr>
                                                                <td class="vertical-middle">
                                                                    <a href="http://nationaltestagency.com/itvarnews">
                                                                    <img src="http://nationaltestagency.com/itvarnews/assets2/img/marketing/main_logo.png" border="0" alt=""/>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                ...
                                <table class="row note">
                                    <tr>
                                        <td class="wrapper last">
                                            <span>Lead Post for <strong><?php echo $segment;?></strong> segment.</span>
                                            ...
                                            <p>
                                                Please click the following URL to login your account:
                                            </p>
                                            <!-- BEGIN: Note Panel -->
                                            <table class="twelve columns" style="margin-bottom: 10px">
                                                <tr>
                                                    <td class="panel">
                                                         ...
                                                         <a href="http://nationaltestagency.com/itvarnews/auth/login">http://nationaltestagency.com/itvarnews/auth/login</a>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table class="row">
                                                <tr>
                                                    <td class="wrapper last">    
                                                        <span style="font-size:12px;"><i>This ia a system generated email and reply is not required.</i></span>                   
                                                    </td>
                                                </tr>
                                            </table>
                                            <!-- END: Unsubscribe -->
