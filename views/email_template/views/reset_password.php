...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ITVARNEWS Reset Password.</title>
                                ...
                                <table class="row note">
                                    <tr>
                                        <td class="wrapper last">
                                            ...
                                            <p>
                                                Please click the following URL to change your password:
                                            </p>
                                            <!-- BEGIN: Note Panel -->
                                            <table class="twelve columns" style="margin-bottom: 10px">
                                                <tr>
                                                    <td class="panel">
                                                     ...
                                                     <?php echo '<a href="'.$reset_link.'">'.$reset_link.'</a>';?>
                                                    </td>
                                            ...
                                            <table class="twelve columns">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <img src="assets/img/email/article.png"  alt=""/>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
