...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ERP Student Registration Information</title>
                                                        ...
                                                        <table class="six columns">
                                                            <tr>
                                                                <td class="vertical-middle">
                                                                    <a href="http://otsinfotechindia.com/SMS">
                                                                    <img src="http://otsinfotechindia.com/SMS/assets/img/school_ERP_header.jpg" border="0" alt=""/>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                ...
                                <table class="row note">
                                    <tr>
                                        <td class="wrapper last">
                                            <h4>Thank you for joining the ERP Systems</h4>
											
											<table class="twelve columns" style="margin-bottom: 10px">
                                               
								<tr>
                                                    <td class="panel">
                                                         Student Login Id : <?php 
                                          ...
                                          <a href="http://otsinfotechindia.com/SMS" target="_blank">Click here Login</a>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
