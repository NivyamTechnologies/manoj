      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="container">
           ...
           <?php 
           foreach ($allachivers as $row){          
           ?>

           <div class="row tpachiv">
      <div class="col-md-2">

  <img src="<?php echo base_url().'achiversimage/'.$row->achivers_image;?>" height="200px;" width="150px;"/>
      </div>
      <div class="col-md-10">
      <h3>
          <span><?php echo $row->achivers_name;?> 
          <?php
          if($row->achivers_level=="stardiamond")
          {
            echo "(Star Diamond)";           
          } 
          elseif($row->achivers_level=="goldleader")
          {
            echo "(Gold Leader)";
          }
          elseif($row->achivers_level=="stargoldleader")
          {
            echo "(Star Gold Leader)";
          }
          elseif($row->achivers_level=="platinumleader")
          {
            echo "(Platinum Leader)";
          }
          elseif($row->achivers_level=="starplatinumleader")
          {
            echo "(Star Platinum Leader)";
          }
          elseif($row->achivers_level=="opalleader")
          {
            echo "(Opal Leader)";
          }
          elseif($row->achivers_level=="diamond")
          {
            echo "(Diamond Leader)";
          }         
          elseif($row->achivers_level=="crowndiamond")
          {
            echo "(Crown Diamond)";
          }
          elseif($row->achivers_level=="starcrowndiamond")
          {
            echo "(Star Crown Diamond)";
          }
          elseif($row->achivers_level=="universaldiamond")
          {
            echo "(Universal Diamond)";
          }
          ?>
          </span></h3>
      
          <span><span style="color: rgb(51, 51, 51)"><span style="font-size: medium">
