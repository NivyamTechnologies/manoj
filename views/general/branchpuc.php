        ...
        <table class="table-responsive del-table table-bordered col-md-12" height="">
                <thead>
                  <tr>
                    ...
                    <td class="col-md-1 col-sm-1"><b>City</b></td>
                    <td class="col-md-1 col-sm-1"><b>State</b></td>
                    <td class="col-md-2 col-sm-2"><b>Name</b></td>
                    <td class="col-md-3 col-sm-3"><b>Address</b></td>
                    <td class="col-md-3 col-sm-3"><b>Mobile</b></td>
                  </tr>
                  </thead>
                  <tbody>
          ...
          ?></span></td><td>
      <span><?php echo $row->bvmbranchname;?></span></td>
       
       <td>
              <span><?php echo $row->address;?></span></td>
                    <td>
                        <span><?php echo $row->mobno;?></span></td>                    
                  </tr>
                   <?php } ?>
                </tbody>
              </table>
         ...
         <div class="col-md-3"> <img src="<?php echo base_url();?>assets/img/branchpuc.jpg" class="img-responsive thumbnail"> </div>
