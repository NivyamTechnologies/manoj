 ...
 <!-- BEGIN TOP BAR -->
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    ...
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>0120-4132645</span></li>
                        <!-- BEGIN CURRENCIES -->
  ...
  <a href="javascript:void(0);" class="mobi-toggler"><i class="fa fa-bars"></i></a>
    ...
    <li><a href="<?php echo base_url();?>login/">Home</a></li>
            ...
            <li><a href="<?php echo base_url();?>login/achivers">Top Achievers</a></li>
             <li><a href="<?php echo base_url();?>login/branchpuc">Branch & PUC</a></li>
      <li><a href="<?php echo base_url();?>login/seminars">Seminars</a></li>
<li><a href="<?php echo base_url();?>login/contact">Contact</a></li>
            <!-- <li><a href="<?php echo base_url();?>login/message">डिस्ट्रीब्यूटर के लिए सन्देश</a></li> -->
    ...
    <div class="col-md-4">
    <div class="address">
           <h3> <span id="ctl00_ContentPlaceHolder1_lblcomname">Adarsh Nirogdham Private Limited</span></h3>
            <span> <i class="fa fa-map-marker" ></i></span><label><span id="ctl00_ContentPlaceHolder1_lbladdress">9/204, Ground Floor , Sector -5, Rajender Nagar, Sahibabad, Ghaziabad (U.P.) Pin Code - 201005</span></label>
           <label><span>Cutomer Care No:- 0120-4132645,</span></label>
           <label><span>Pick Up Center Customer Care No:-+91 954053329,</span></label>
           <label><span>Whatsapp No.:- 09540633222,</span></label>
           <span > <i class="fa fa-phone"></i> </span>
             <span > <i class="fa fa-envelope"></i></span>
             <label>Email Id:<span id="ctl00_ContentPlaceHolder1_lblemailcare">Customercare@bvmbusiness.com</span></label>
          <span > <i class="fa fa-weibo" ></i></span>
          <label>WebSite:<span id="ctl00_ContentPlaceHolder1_lblwebsite">www.bvmbusiness.com</span></label>
    ...
    <h3>Get In Touch !</h3>
    <div class="row">
    <?php echo form_open_multipart('login/contact'); ?>
    <div class="col-md-6">
  ...
  <input name="name" type="text" required class="form-control" placeholder="Enter Name" />
    ...
    <div class="form-group">
      <label for="email">Mobile:</label>
          <input name="mobile" required type="text" id="mobile" class="form-control" placeholder="Enter Mobile" />
    ...
    <label for="email">Message:</label>
        <textarea name="message" rows="2" required cols="20" class="form-control" placeholder="Message">
</textarea>
    
    </div>
    <div class="col-md-12">
        <input type="submit" name="contact" value="Submit" class="btn btn-default" />
