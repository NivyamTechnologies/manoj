            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                 ...
                 <!-- <?php $attributes = array('class' => 'form-horizontal form-without-legend','role' => 'form');
    echo form_open('login/check_login_user',$attributes);?> -->

    <form name="login" action="<?php echo base_url(); ?>login/forget" method="POST" class="form-horizontal">

                  
                    <div class="form-group">
                      <label for="email" class="col-lg-4 control-label">Your Id <span class="require">*</span></label>
                      <div class="col-lg-8">
  <?php $inputclass = array('name' => 'applicant_no','class' => 'form-control','required'=>true); 
            echo form_input($inputclass);?>
                      </div>
                    </div>
                     <!-- <div class="form-group">
                      <label for="email" class="col-lg-4 control-label">Your Current Password <span class="require">*</span></label>
                      <div class="col-lg-8">
                      <?php $inputclass1 = array('name' => 'oldpassword','class' => 'form-control','required'=>true); 
            echo form_password($inputclass1);?>
                      </div>
                    </div> -->
                  <!--   <div class="form-group">
                      <label for="password" class="col-lg-4 control-label">New Password <span class="require">*</span></label>
                      <div class="col-lg-8">
                       <?php $passwordclass = array('name' => 'newpassword', 'class' => 'form-control','id'=>'password','required'=>true); 
            echo form_password($passwordclass);?>                       
                    ...
                    <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                         ...
                         <?php $submitclass = array('name' => 'submit','type' => 'submit','value' => true, 'class' => 'btn btn-primary','content'=>'Reset Pasword');          
