...
<!-- 
	...
	<!-- Header Starts -->
		...
		<!-- Slider Starts -->
			...
			<div id="slider" class="slider clearfix">
				<div id="camera_wrap_1" class="">
				<!-- Slide #1 Starts -->
					<div data-src="<?php echo base_url();?>assets/new/images/slider/slider-img1.jpeg">
				...
				<!-- Slide #1 Ends -->
				<!-- Slide #2 Starts -->
					<div data-src="<?php echo base_url();?>assets/new/images/slider/slider-img2.jpeg">
						...
						<!-- Navbar Collapse Starts -->
						  <div class="navbar-collapse collapse">
								...
								<li><a href="#">Home</a></li>
									...
									<li><a href="<?php echo base_url();?>assets/AssurednessPlan.pdf" target="_blank">Plan</a></li>
	...
	<!-- About Section Starts -->
		...
		<!-- Nested Container Starts -->
			<div class="container">
				<h2><span>About Assuredness</span></h2>
				<div class="content text-center">
					<p>
						Assuredness is an India based Direct Selling Company that offers personal care,
health and wellness and home care products. The representatives can also
sign up new reps that are in their downline, and they will make commissions
on their sales also. Many Indian representatives have made a healthy
income selling these products and also attracting other Assuredness
representatives. 
					</p>
				</div>
				<!-- <div class="row about-banners">
                	<div class="col-md-3 col-sm-6 col-xs-12">
						<a href="#"><img src="<?php echo base_url();?>assets/new/images/banners/about-banner-img-1.png" alt="Banner 1" class="img-responsive"></a>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<a href="#"><img src="<?php echo base_url();?>assets/new/images/banners/about-banner-img-2.png" alt="Banner 2" class="img-responsive"></a>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12">
						<a href="#"><img src="<?php echo base_url();?>assets/new/images/banners/about-banner-img-3.png" alt="Banner 3" class="img-responsive"></a>
					</div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
						<a href="#"><img src="<?php echo base_url();?>assets/new/images/banners/about-banner-img-4.png" alt="Banner 2" class="img-responsive"></a>
					</div>
				</div> -->
			</div>
		<!-- Nested Container Ends -->
						...
						<div class="item active">
							...
							<!-- Product #1 Starts -->
								...
								<!-- Thumbnail Starts -->
									...
									<!-- Product Image #1 Starts -->
										<img src="<?php echo base_url();?>assets/new/images/shop.jpeg" alt="Product Image" class="img-responsive">
									...
									<!-- Product Caption Starts -->
										<div class="caption">
											...
											<!-- Product Name & Price Starts -->
												<div class="clearfix">
													<h5 class="product-heading">45/-</h5>
													<h4 class="price">
							...
							<!-- Product #2 Starts -->
								...
								<!-- Thumbnail Starts -->
									...
									<img src="<?php echo base_url();?>assets/new/images/paste.jpeg" alt="Product Image" class="img-responsive">
									...
									<!-- Product Caption Starts -->
										<div class="caption">
											...
											<!-- Product Name & Price Starts -->
												<div class="clearfix">
													<h5 class="product-heading">75/-</h5>
													<h4 class="price">
							...
							<!-- Product #3 Starts -->
								...
								<!-- Thumbnail Starts -->
									...
									<img src="<?php echo base_url();?>assets/new/images/cal.jpeg" alt="Product Image" class="img-responsive">
									...
									<!-- Product Caption Starts -->
										<div class="caption">
											...
											<!-- Product Name & Price Starts -->
												<div class="clearfix">
													<h5 class="product-heading">225/-</h5>
													<h4 class="price">
								...
								<!-- Thumbnail Starts -->
									...
									<!-- Product Caption Starts -->
										<div class="caption">
											...
											<!-- Product Name & Price Starts -->
												<div class="clearfix">
													<h5 class="product-heading">Comming soon</h5>
													<h4 class="price">
														<span class="price-old"> </span>
	...
	<!-- Recent Articles Section Starts -->
		<section id="recent-articles" class="recent-articles section-area inverse parallax">
		<!-- Nested Container Starts -->
			<div class="container">
				<h2><span style="color: darkturquoise;">Recent Articles</span></h2>
				<div class="row">
					<div class="col-md-5 col-xs-12">
						<div class="content-box">
							<img src="<?php echo base_url();?>assets/new/images/pexels-photo-1645693.jpeg" alt="Image1" class="img-responsive">
							<h3>Direct Selling OPPORTUNITY</h3>
							<p>
							Direct Selling Business are often the first entrepreneurship opportunity people are drawn to when trying to make side money. If you pick the right business and are really fired up, perhaps your side hustle could become your full-time revenue stream.  However, before you jump in feet first, you need to evaluate if the Direct Selling opportunity is the right thing for you.
							</p>
						...
						<div class="content-box">
							<div class="row">
								<div class="col-sm-7 col-xs-12">
									...
									<p>
									Ayurveda means knowledge (veda) of life (ayus). It is one of the ancient Indian systems of healthcare and involves bringing about balance between body and mind. It includes individualized herbal remedies, diet, exercise (yoga), meditation, massage and other interventions.
									</p>
									<a href="#" class="read-more">Learn More...</a>
								</div>
								<div class="col-sm-5 col-xs-12">
									<img src="<?php echo base_url();?>assets/new/images/ayur.png" alt="Image2" class="img-responsive">
								</div>
							</div>
						</div>
						<div class="content-box">
	...
	<!-- Testimonials Section Starts -->
		<section id="testimonial" class="testimonial section-area parallax">
		<!-- Nested Container Starts -->
			<div class="container">
				<div class="row">
					<h2 class="text-center">
						<i class="fa fa-quote-left"></i>
						<span class="hide">Quote</span>
					</h2>
					...
					<!-- Wrapper For Sliders Starts -->
						...
						<!-- Quote #1 Starts -->
							<div class="item active">
								<blockquote>
									<p>
										To motivate everyone to realize and recognize their inner potential and turn it into a an asset for personal growth and overall success.
									</p>
									<h4>Ram Charan Jaikishan</h4>
								</blockquote>
							</div>
						<!-- Quote #1 Ends -->
						<!-- Quote #2 Starts -->
						...
						<div class="row">
							...
							<div class="col-md-7 col-xs-12">
								<ul class="list-unstyled list-inline sm-links">
									<li>
										<a href="https://twitter.com/assuredness10"><i class="fa fa-twitter"></i></a>
									</li>
									<li>
									<a href="https://www.facebook.com/assurdness"><i class="fa fa-facebook"></i></a>
									</li>
									<li>
										<a href="https://www.instagram.com/assurednessofficial/"><i class="fa fa-instagram"></i></a>
									</li>
									<li>
				...
				<div class="row foot-brand-logo">
					<div class="col-sm-6 col-xs-12 col-sm-offset-3">
						<ul class="list-unstyled text-center">
							...
							<li>
								Email : <a href="mailto">customercare@myassuredness.com </a>, Telephone No: +91-90586-70777
							</li>
						</ul>
					</div>
				</div>
