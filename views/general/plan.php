      ...
      <div class="container">
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12 col-sm-12">
            ...
            if($i == 5)
            {?>
              <h1 class="text-center">WORKING-PLAN</h1>
            <?php }
            if($i == 4)
            {
              echo "<br/>";
            ...
            if($i == 1)
            { ?>
            <h1 class="text-center">NONWORKING-PLAN</h1>
            <?php }       
            ?>
             <div class="col-lg-3 col-md-4 col-xs-6">
            <a class="thumbnail1" href="#" data-image-id="" data-toggle="modal" data-title="<?php echo $row->plan_name;?>" data-caption="And if there is money left, my girlfriend will receive this car" data-image="<?php echo base_url().'planimage/'.$row->plan_image;?>" data-target="#image-gallery">
                <div class="block1">
              
                    <div class="circle1">
                        <p class="text-center" style="font-size:30px;">
                        <span><?php echo $row->plan_persent;?><br> %</span>
                        </p>
                    </div>
                  <p><strong><?php echo $row->plan_name;?></strong></p>
