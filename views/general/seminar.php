 ...
 <!-- BEGIN TOP BAR -->
  ...
  <a href="javascript:void(0);" class="mobi-toggler"><i class="fa fa-bars"></i></a>
    ...
    <li><a href="<?php echo base_url();?>login/">Home</a></li>
            ...
            <li><a href="<?php echo base_url();?>login/achievers">Top Achievers</a></li>
...
<li><a href="<?php echo base_url();?>login/contact">Contact</a></li>
    ...
    <div class="container">
      <div class="row ">
      <style>
      .del-table td{padding:8px 12px; text-align:center;}
    .del-table thead{background:#6BC73A; color:#fff; border-bottom:0;}
      </style>
        <div class="col-md-12">
        <table class="table-responsive del-table table-bordered col-md-12" height="">
                <thead>
                  <tr>
                    <td class="col-md-1 col-sm-1"><b>S.No</b></td>
                    <td class="col-md-1 col-sm-1"><b>Date</b></td>
                    <td class="col-md-1 col-sm-1"><b>Time</b></td>
                    <td class="col-md-2 col-sm-2"><b>State</b></td>
                    <td class="col-md-3 col-sm-3"><b>City</b></td>
                    <td class="col-md-3 col-sm-3"><b>Venue</b></td>
                    <td class="col-md-3 col-sm-3"><b>Leader</b></td>
                    <td class="col-md-3 col-sm-3"><b>Type</b></td>
                    <td class="col-md-3 col-sm-3"><b>Contact</b></td>
                  </tr>
                  </thead>
                  <tbody>
                      ...
                      <?php
                      $sn=1;
                      foreach($allseminar as $row)
                      {
                        $Type = $row->seminar_type;
                        $seminardate = date_create($row->seminar_date);
                        $dateseminar = date_format($seminardate,"d-M-Y");
                      ?>

                  <tr>
                    <td>
                <span><?php echo $sn++;?></span></td>
                <td>
                <span><?php echo $dateseminar;?></span></td>
              <td>
                <span><?php echo $row->seminar_time;?></span></td>
                <td>
                  <?php 
                            $qq = $this->base_model->getState($row->state);
                          echo  $qq[0]['state_name'];
                            ?>
                </td>
       
       <td>
              <span><?php echo $row->city;?></span></td>
                    <td>
                        <span><?php echo $row->venue;?></span></td> 
                         <td>
                        <span><?php echo $row->leader;?></span></td>
                        <td>
                  <?php 
                  if($Type=="seminar")
                  {
                ...
                <td>
                        <span><?php echo $row->contact;?></span></td>                      
                  </tr>
                   <?php } ?>
                </tbody>
              </table>
