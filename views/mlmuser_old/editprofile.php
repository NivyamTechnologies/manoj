...
Edit Profile
	...
	<form class="form-horizontal" action="<?php echo base_url(); ?>login/editmyprofile" name="registration" method="POST" enctype='multipart/form-data'>
                  ...
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>Sponser No:</td>
                        <td>
						<input type="text" class="form-control" id="sponsorno" name ="sponsorno" value="<?php echo $userview[0]->sponser_no;?>" readonly onchange="getsn(this.value)" placeholder="Sponsor No.">
						<input type="hidden" class="form-control" name ="edit" value="<?php echo $userview[0]->edit ;?>">
                      ...
                      <tr>
                        ...
                        <td>Phone Number</td>
                        <td><input type='text' class="form-control" id="othermobileno" value="<?php echo $userview[0]->phone_no;?>" name="othermobileno" placeholder="Other mobile No.">(Landline)<br><br><input type='text' class="form-control" id="mobileno" value="<?php echo $userview[0]->mobile_no;?>" name="mobileno" <?php echo $readonly;  ?> placeholder="Mobile No.">(Mobile)
                        </td>
						...
						<select class="form-control" disabled id="applicantdobdate" readonly name="applicantdobdate" style="width:90px;float: left; margin-right: 5px;">
						  ...
						  <select class="form-control" disabled id="applicantdobmonth" readonly name="applicantdobmonth" style="width:90px;float: left; margin-right: 5px;">
						  ...
						  <select class="form-control" disabled id="applicantdobyear" readonly name="applicantdobyear" style="width:100px;">
                        ...
                        <tr>
                        <td>Nominee Name.:</td>
                        <td><input type="text" class="form-control" id="nomineename" name="nomineename" disabled value="<?php echo $userview[0]->nomnee_name;?>" placeholder="Nominee Name."></td>
                      </tr>
						...
						<select class="form-control" disabled id="nomineedobdate" name="nomineedobdate" style="width:90px;float: left; margin-right: 5px;">
						  <option value="">Date</option>
						  <?php 
						  for($i=1;$i<=31;$i++) 
						  {
						  ...
						  <select class="form-control" disabled id="nomineedobmonth" name="nomineedobmonth" style="width:90px;float: left; margin-right: 5px;">
						  <option value="">Month</option>
						  <?php 
						  for($i=1;$i<=12;$i++) 
						  {
						  ...
						  <select class="form-control" disabled id="nomineedobyear" name="nomineedobyear" onblur="agecal(this.value)" style="width:100px;">
						  <option value="">Year</option>
						  <?php 
						  for($i=1940;$i<=date('Y');$i++) 
						  {
                        ...
                        <tr>
                        <td>Relation:</td>
                        <td><input type="text" readonly class="form-control" id="relation" name="relation" value="<?php echo $userview[0]->nomnee_rel;?>" placeholder="Relation."></td>
                      </tr>
					  ...
					  <tr>
					   ...
					   <tr>
						...
						<select class="form-control" id="district" name="district">
						  <option value="<?php echo $userview[0]->district_id; ?>"><?php echo $userview[0]->district_name; ?></option>
						  </select></td>
                      </tr>
                        <tr>
                        <td>Tehsil:</td>
                     ...
                     <tr>
					  ...
					  <tr>
                        <td>Bank Name:</td>
                        <td>
						<select class="form-control" disabled id="bankname" <?php echo $readonly;  ?> name="bankname">
					  ...
					  <tr>
                        <td>Bank Branch State Name:</td>
                        <td>
						<select class="form-control" disabled id="bankbranchstate" <?php echo $readonly;  ?> name="bankbranchstate">
