		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Distributor IGST Bill 
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						
						<li>
							<i class="fa fa-home"></i>
							<a href="<?php echo base_url()?>admin/distchalanIGST">
							Bill
							</a>
						...
						<div class="tab-pane " id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
					<?php echo form_open_multipart('puc/adddistchalanIGST/'); ?>
...
jQuery.post("<?php echo base_url();  ?>admin/getdistdata", {no: str}, function(result){
  ...
  $( function() {
    ...
    $( "#productlist" ).autocomplete({
     ...
     htmls += "<td><input  name='tax_rate[]' type='text' id='tax_rate"+k+"' readonly value='"+product_taxrate+"' class='form-control input-md'></td>";
	 htmls += "<td><input  name='igst[]' type='text' id='igst"+k+"'  readonly class='form-control input-md'><input  name='tax_rate_igst[]' type='hidden' id='tax_rate_igst"+k+"' readonly value='"+product_igst+"' class='form-control input-md'></td>";
