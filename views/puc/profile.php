...
color: #fff;">Current month</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	         	...
	         	<div class="desc" style="font-size: 25px; color: #fff;">
								<?php echo "Total GBV:".$total[0]['totalbv'];  ?>
							</div>
							<div class="desc" style="font-size: 25px; color: #fff;">
								<?php echo "SELF BV:".$total[0]['totalbv'];  ?>
							</div>
						</div>
...
color: #fff;"></div>
						...
						<div align="center" style="font-size: 12px;
color: #fff;">Current month RP </div>
						
					
							<div class="desc" style="font-size: 20px;">
								  <?php echo "RP: ".$rpcommission[0]['rpcomm'];  ?>
							</div>
