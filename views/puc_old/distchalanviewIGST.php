        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								<a href="<?php echo base_url();?>puc/distchalanIGST/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
								<?php }elseif($r->chalantype == 2){?>
								<a href="<?php echo base_url();?>puc/distchalanCGST/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
							    <?php } ?>
							    </td>
