        ...
        <?php } ?>  
							...
							<tr>								
                               ...
                               <td>
								...
								elseif($r->transport=='no')
								{
								?>
								<a href="<?php echo base_url();?>puc/schemechalan/<?php echo $r->chalan_id;?>" target="_blank">View Chalan</a>
                                <?php								
								}
								?>
							    </td>
								...
								?>
								<td>
								<a href="<?php echo base_url(); ?>puc/receivequantityscheme/<?php echo $r->chalan_id;?>/<?php echo $r->branch_id;?>">Receive</a>
								</td>
                                <?php								
								}
								}
