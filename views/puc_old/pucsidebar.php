		        ...
		        <li>
					<a href="<?php if($value['menu_link']){echo base_url().$value['menu_link'];}else{ echo "#";} ?>">
						...
						<span class="arrow">
						 ...
						 {
						  $ar =array();
							  $change = explode('/',$value1['menu_link']);
							  foreach($change as $ch)
							  {
							  if(strtolower($ch) == 'branch' or strtolower($ch) == 'admin')
							  {
                              $ar[]='puc';
							  }	
                              else
                         ...
                         <li>
                          ...
                          if($value1['subchildcount']>0)
							  ...
							  {
								  	  $ar =array();
							  $change = explode('/',$value2['menu_link']);
							  foreach($change as $ch)
							  {
							  if(strtolower($ch) == 'branch' or strtolower($ch) == 'admin')
							  {
                            ...
                            if($value2['subsubchildcount']>0)
							  ...
							  {
								 $ar =array();
							  $change = explode('/',$value3['menu_link']);
							  foreach($change as $ch)
							  {
							  if(strtolower($ch) == 'branch' or strtolower($ch) == 'admin')
							  {
